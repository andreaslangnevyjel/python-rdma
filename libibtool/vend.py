...
class MlxGeneralInfo(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset: int=0):
        ...
        struct.pack_into(
            ">QHH", buffer, offset + 0, self.reserved_0, self.hw_revision, self.device_id
        )
        struct.pack_into(
            ">LBBBBLBBHHH",
            buffer, offset + 36, self.uptime, self.reserved_320, self.fw_major,
            self.fw_minor, self.fw_sub_minor, self.fw_build_id, self.fw_month, self.fw_day, self.fw_year,
            self.reserved_416, self.fw_hour,
        )
        struct.pack_into(
            ">LBBBB", buffer, offset + 72, self.fw_init_file_version, self.reserved_608, self.hw_major,
    ...
    def unpack_from(self, buffer, offset: int=0):
        ...
        (
            ...
            self.fw_month, self.fw_day, self.fw_year, self.reserved_416, self.fw_hour
        ) = struct.unpack_from(
            ">LBBBBLBBHHH",
            buffer,
            offset + 36,
