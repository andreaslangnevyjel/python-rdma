...
class EndPort(SysFSCache):
    ...
    @property
    def lid(self):
        return self._cached_sysfs("lid", _conv_hex)

    @property
    def lmc(self):
        return self._cached_sysfs("lid_mask_count", int)
    ...
    @property
    def sm_lid(self):
        return self._cached_sysfs("sm_lid", _conv_hex)

    @property
    def sm_sl(self):
        return self._cached_sysfs("sm_sl", int)

    @property
    def port_guid(self):
        return self._cached_sysfs("gids/0", _conv_gid2guid)
...
class RDMADevice(SysFSCache):
    ...
    @property
    def node_guid(self):
        return self._cached_sysfs("node_guid", IBA.GUID)

    @property
    def node_desc(self):
        return self._cached_sysfs("node_desc", _conv_unicode)
    ...
    def sys_image_guid(self):
        return self._cached_sysfs("sys_image_guid", IBA.GUID)
