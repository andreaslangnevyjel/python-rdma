...
class HdrLRH(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_0_32(self):
        return ((self.VL & 0xF) << 28) | ((self.LVer & 0xF) << 24) | ((self.SL & 0xF) << 20) | (
                (self.reserved_12 & 0x3) << 18) | ((self.LNH & 0x3) << 16) | ((self.DLID & 0xFFFF) << 0)
...
class HdrBTH(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_0_32(self):
        return ((self.service & 0x7) << 29) | ((self.function & 0x1F) << 24) | ((self.SE & 0x1) << 23) | (
                (self.migReq & 0x1) << 22) | ((self.padCnt & 0x3) << 20) | ((self.TVer & 0xF) << 16) | (
                       (self.PKey & 0xFFFF) << 0)
...
class HdrFlowControl(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_0_32(self):
        return ((self.op & 0xF) << 28) | ((self.FCTBS & 0xFFF) << 16) | ((self.VL & 0xF) << 12) | (
                (self.FCCL & 0xFFF) << 0)
...
class CMPath(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'SLID', 'DLID', 'SGID', 'DGID', 'flowLabel', 'reserved_308', 'reserved_312', 'PD', 'TClass', 'hopLimit', 'SL',
    'subnetLocal', 'reserved_341', 'localACKTimeout', 'reserved_349')
    MAD_LENGTH = 44
    MEMBERS = [('SLID', 16, 1), ('DLID', 16, 1), ('SGID', 128, 1), ('DGID', 128, 1), ('flowLabel', 20, 1),
               ('reserved_308', 4, 1), ('reserved_312', 2, 1), ('PD', 6, 1), ('TClass', 8, 1), ('hopLimit', 8, 1),
               ('SL', 4, 1), ('subnetLocal', 1, 1), ('reserved_341', 3, 1), ('localACKTimeout', 5, 1),
               ('reserved_349', 3, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.flowLabel & 0xFFFFF) << 12) | ((self.reserved_308 & 0xF) << 8) | (
                (self.reserved_312 & 0x3) << 6) | ((self.PD & 0x3F) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.TClass & 0xFF) << 24) | ((self.hopLimit & 0xFF) << 16) | ((self.SL & 0xF) << 12) | (
                (self.subnetLocal & 0x1) << 11) | ((self.reserved_341 & 0x7) << 8) | (
                       (self.localACKTimeout & 0x1F) << 3) | ((self.reserved_349 & 0x7) << 0)
...
class CMREQ(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'LCID', 'reserved_32', 'serviceID', 'LGUID', 'localCMQKey', 'localQKey', 'localQPN', 'responderResources',
    'localEECN', 'initiatorDepth', 'remoteEECN', 'remoteResponseTimeout', 'transportService', 'flowControl',
    'startingPSN', 'localResponseTimeout', 'retryCount', 'PKey', 'pathPacketMTU', 'RDCExists', 'RNRRetryCount',
    'maxCMRetries', 'reserved_412', 'primaryPath', 'alternatePath', 'privateData')
    MAD_LENGTH = 232
    MAD_ATTRIBUTE_ID = 0x10
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('reserved_32', 32, 1), ('serviceID', 64, 1), ('LGUID', 64, 1), ('localCMQKey', 32, 1),
               ('localQKey', 32, 1), ('localQPN', 24, 1), ('responderResources', 8, 1), ('localEECN', 24, 1),
               ('initiatorDepth', 8, 1), ('remoteEECN', 24, 1), ('remoteResponseTimeout', 5, 1),
               ('transportService', 2, 1), ('flowControl', 1, 1), ('startingPSN', 24, 1),
               ('localResponseTimeout', 5, 1), ('retryCount', 3, 1), ('PKey', 16, 1), ('pathPacketMTU', 4, 1),
               ('RDCExists', 1, 1), ('RNRRetryCount', 3, 1), ('maxCMRetries', 4, 1), ('reserved_412', 4, 1),
               ('primaryPath', 352, 1), ('alternatePath', 352, 1), ('privateData', 736, 1)]
    ...
    @property
    def _pack_2_32(self):
        return ((self.remoteEECN & 0xFFFFFF) << 8) | ((self.remoteResponseTimeout & 0x1F) << 3) | (
                (self.transportService & 0x3) << 1) | ((self.flowControl & 0x1) << 0)
    ...
    @property
    def _pack_3_32(self):
        return ((self.startingPSN & 0xFFFFFF) << 8) | ((self.localResponseTimeout & 0x1F) << 3) | (
                (self.retryCount & 0x7) << 0)
    ...
    @property
    def _pack_4_32(self):
        return ((self.PKey & 0xFFFF) << 16) | ((self.pathPacketMTU & 0xF) << 12) | ((self.RDCExists & 0x1) << 11) | (
                (self.RNRRetryCount & 0x7) << 8) | ((self.maxCMRetries & 0xF) << 4) | ((self.reserved_412 & 0xF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLLLLL', buffer, offset + 24, self.localCMQKey, self.localQKey, self._pack_0_32,
                         self._pack_1_32, self._pack_2_32, self._pack_3_32, self._pack_4_32)
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.localCMQKey, self.localQKey, self._pack_0_32, self._pack_1_32, self._pack_2_32, self._pack_3_32,
         self._pack_4_32,) = struct.unpack_from('>LLLLLLL', buffer, offset + 24)


class CMMRA(rdma.binstruct.BinStruct):
    """Message Receipt Acknowledgement (section 12.6.6)"""
    __slots__ = (
    'LCID', 'RCID', 'messageMRAed', 'reserved_66', 'serviceTimeout', 'reserved_77', 'reserved_80', 'privateData')
    MAD_LENGTH = 232
    MAD_ATTRIBUTE_ID = 0x11
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('RCID', 32, 1), ('messageMRAed', 2, 1), ('reserved_66', 6, 1),
               ('serviceTimeout', 5, 1), ('reserved_77', 3, 1), ('reserved_80', 16, 1), ('privateData', 1760, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.messageMRAed & 0x3) << 30) | ((self.reserved_66 & 0x3F) << 24) | (
                (self.serviceTimeout & 0x1F) << 19) | ((self.reserved_77 & 0x7) << 16) | (
                       (self.reserved_80 & 0xFFFF) << 0)
...
class CMREJ(rdma.binstruct.BinStruct):
    ...
    __slots__ = ('LCID', 'RCID', 'messageRejected', 'reserved_66', 'rejectInfoLength', 'reserved_79', 'reason', 'ARI',
                 'privateData')
    MAD_LENGTH = 232
    MAD_ATTRIBUTE_ID = 0x12
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('RCID', 32, 1), ('messageRejected', 2, 1), ('reserved_66', 6, 1),
               ('rejectInfoLength', 7, 1), ('reserved_79', 1, 1), ('reason', 16, 1), ('ARI', 576, 1),
               ('privateData', 1184, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.messageRejected & 0x3) << 30) | ((self.reserved_66 & 0x3F) << 24) | (
                (self.rejectInfoLength & 0x7F) << 17) | ((self.reserved_79 & 0x1) << 16) | ((self.reason & 0xFFFF) << 0)
...
class CMREP(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'LCID', 'RCID', 'localQKey', 'localQPN', 'reserved_120', 'localEEContext', 'reserved_152', 'startingPSN',
    'reserved_184', 'responderResources', 'initiatorDepth', 'targetACKDelay', 'failoverAccepted', 'flowControl',
    'RNRRetryCount', 'reserved_219', 'LGUID', 'privateData')
    MAD_LENGTH = 232
    MAD_ATTRIBUTE_ID = 0x13
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('RCID', 32, 1), ('localQKey', 32, 1), ('localQPN', 24, 1), ('reserved_120', 8, 1),
               ('localEEContext', 24, 1), ('reserved_152', 8, 1), ('startingPSN', 24, 1), ('reserved_184', 8, 1),
               ('responderResources', 8, 1), ('initiatorDepth', 8, 1), ('targetACKDelay', 5, 1),
               ('failoverAccepted', 2, 1), ('flowControl', 1, 1), ('RNRRetryCount', 3, 1), ('reserved_219', 5, 1),
               ('LGUID', 64, 1), ('privateData', 1568, 1)]
    ...
    @property
    def _pack_3_32(self):
        return ((self.responderResources & 0xFF) << 24) | ((self.initiatorDepth & 0xFF) << 16) | (
                (self.targetACKDelay & 0x1F) << 11) | ((self.failoverAccepted & 0x3) << 9) | (
                       (self.flowControl & 0x1) << 8) | ((self.RNRRetryCount & 0x7) << 5) | (
                       (self.reserved_219 & 0x1F) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLLLLL', buffer, offset + 0, self.LCID, self.RCID, self.localQKey, self._pack_0_32,
                         self._pack_1_32, self._pack_2_32, self._pack_3_32)

    def unpack_from(self, buffer, offset=0):
        self.LGUID = IBA.GUID(buffer[offset + 28:offset + 36], raw=True)
        self.privateData = bytearray(buffer[offset + 36:offset + 232])
        (self.LCID, self.RCID, self.localQKey, self._pack_0_32, self._pack_1_32, self._pack_2_32,
         self._pack_3_32,) = struct.unpack_from('>LLLLLLL', buffer, offset + 0)
...
class CMLAP(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'LCID', 'RCID', 'QKey', 'RQPN', 'RCMTimeout', 'reserved_125', 'reserved_128', 'altSLID', 'altDLID', 'altSGID',
    'altDGID', 'altFlowLabel', 'reserved_468', 'altTClass', 'altHopLimit', 'reserved_488', 'altIPD', 'altSL',
    'altSubnetLocal', 'reserved_501', 'altLocalACKTimeout', 'reserved_509', 'privateData')
    MAD_LENGTH = 232
    MAD_ATTRIBUTE_ID = 0x19
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('RCID', 32, 1), ('QKey', 32, 1), ('RQPN', 24, 1), ('RCMTimeout', 5, 1),
               ('reserved_125', 3, 1), ('reserved_128', 32, 1), ('altSLID', 16, 1), ('altDLID', 16, 1),
               ('altSGID', 128, 1), ('altDGID', 128, 1), ('altFlowLabel', 20, 1), ('reserved_468', 4, 1),
               ('altTClass', 8, 1), ('altHopLimit', 8, 1), ('reserved_488', 2, 1), ('altIPD', 6, 1), ('altSL', 4, 1),
               ('altSubnetLocal', 1, 1), ('reserved_501', 3, 1), ('altLocalACKTimeout', 5, 1), ('reserved_509', 3, 1),
               ('privateData', 1344, 1)]
    ...
    @property
    def _pack_2_32(self):
        return ((self.altHopLimit & 0xFF) << 24) | ((self.reserved_488 & 0x3) << 22) | ((self.altIPD & 0x3F) << 16) | (
                (self.altSL & 0xF) << 12) | ((self.altSubnetLocal & 0x1) << 11) | ((self.reserved_501 & 0x7) << 8) | (
                       (self.altLocalACKTimeout & 0x1F) << 3) | ((self.reserved_509 & 0x7) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLLLHH', buffer, offset + 0, self.LCID, self.RCID, self.QKey, self._pack_0_32,
                         self.reserved_128, self.altSLID, self.altDLID)
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.LCID, self.RCID, self.QKey, self._pack_0_32, self.reserved_128, self.altSLID,
         self.altDLID,) = struct.unpack_from('>LLLLLHH', buffer, offset + 0)
...
class CMAPR(rdma.binstruct.BinStruct):
    ...
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('LCID', 32, 1), ('RCID', 32, 1), ('additionalInfoLength', 8, 1), ('APstatus', 8, 1),
               ('reserved_80', 16, 1), ('additionalInfo', 576, 1), ('privateData', 1184, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        ...
        buffer[offset + 84:offset + 232] = self.privateData
        struct.pack_into('>LLBBH', buffer, offset + 0, self.LCID, self.RCID, self.additionalInfoLength, self.APstatus,
                         self.reserved_80)

    def unpack_from(self, buffer, offset=0):
        self.additionalInfo = bytearray(buffer[offset + 12:offset + 84])
        self.privateData = bytearray(buffer[offset + 84:offset + 232])
        (self.LCID, self.RCID, self.additionalInfoLength, self.APstatus, self.reserved_80,) = struct.unpack_from(
            '>LLBBH', buffer, offset + 0)
...
class CMSIDR_REP(rdma.binstruct.BinStruct):
    ...
    MAD_COMMMGTSEND = 0x3  # MAD_METHOD_SEND
    MEMBERS = [('requestID', 32, 1), ('QPN', 24, 1), ('status', 8, 1), ('serviceID', 64, 1), ('QKey', 32, 1),
               ('classPortinfo', 576, 1), ('privateData', 1120, 1)]
...
class MADHeaderDirected(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_0_32(self):
        return ((self.D & 0x1) << 31) | ((self.status & 0x7FFF) << 16) | ((self.hopPointer & 0xFF) << 8) | (
                (self.hopCount & 0xFF) << 0)
...
class MADClassPortInfo(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>BBHL', buffer, offset + 0, self.baseVersion, self.classVersion, self.capabilityMask,
                         self._pack_0_32)
        struct.pack_into('>LHHLL', buffer, offset + 24, self._pack_1_32, self.redirectLID, self.redirectPKey,
                         self._pack_2_32, self.redirectQKey)
        struct.pack_into('>LHHLL', buffer, offset + 56, self._pack_3_32, self.trapLID, self.trapPKey, self._pack_4_32,
                         self.trapQKey)

    def unpack_from(self, buffer, offset=0):
        self.redirectGID = IBA.GID(buffer[offset + 8:offset + 24], raw=True)
        self.trapGID = IBA.GID(buffer[offset + 40:offset + 56], raw=True)
        (self.baseVersion, self.classVersion, self.capabilityMask, self._pack_0_32,) = struct.unpack_from('>BBHL',
                                                                                                          buffer,
                                                                                                          offset + 0)
        (
        self._pack_1_32, self.redirectLID, self.redirectPKey, self._pack_2_32, self.redirectQKey,) = struct.unpack_from(
            '>LHHLL', buffer, offset + 24)
        (self._pack_3_32, self.trapLID, self.trapPKey, self._pack_4_32, self.trapQKey,) = struct.unpack_from('>LHHLL',
                                                                                                             buffer,
                                                                                                             offset + 56)
...
class MADInformInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'GID', 'LIDRangeBegin', 'LIDRangeEnd', 'reserved_160', 'isGeneric', 'subscribe', 'type', 'trapNumber', 'QPN',
    'reserved_248', 'respTimeValue', 'reserved_256', 'producerType')
    MAD_LENGTH = 36
    MAD_ATTRIBUTE_ID = 0x3
    MAD_SUBNADMSET = 0x2  # MAD_METHOD_SET
    COMPONENT_MASK = {
        'GID': 0, 'LIDRangeBegin': 1, 'LIDRangeEnd': 2, 'reserved_160': 3, 'isGeneric': 4, 'subscribe': 5, 'type': 6,
        'trapNumber': 7, 'QPN': 8, 'reserved_248': 9, 'respTimeValue': 10, 'reserved_256': 11, 'producerType': 12
    }
    MEMBERS = [('GID', 128, 1), ('LIDRangeBegin', 16, 1), ('LIDRangeEnd', 16, 1), ('reserved_160', 16, 1),
               ('isGeneric', 8, 1), ('subscribe', 8, 1), ('type', 16, 1), ('trapNumber', 16, 1), ('QPN', 24, 1),
               ('reserved_248', 3, 1), ('respTimeValue', 5, 1), ('reserved_256', 8, 1), ('producerType', 24, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>HHHBBHHLL', buffer, offset + 16, self.LIDRangeBegin, self.LIDRangeEnd, self.reserved_160,
                         self.isGeneric, self.subscribe, self.type, self.trapNumber, self._pack_0_32, self._pack_1_32)

    def unpack_from(self, buffer, offset=0):
        self.GID = IBA.GID(buffer[offset + 0:offset + 16], raw=True)
        (self.LIDRangeBegin, self.LIDRangeEnd, self.reserved_160, self.isGeneric, self.subscribe, self.type,
         self.trapNumber, self._pack_0_32, self._pack_1_32,) = struct.unpack_from('>HHHBBHHLL', buffer, offset + 16)
...
class RMPPHeader(rdma.binstruct.BinStruct):
    ...
    MAD_LENGTH = 36
    MEMBERS = [('MADHeader', 192, 1), ('RMPPVersion', 8, 1), ('RMPPType', 8, 1), ('RRespTime', 5, 1),
               ('RMPPFlags', 3, 1), ('RMPPStatus', 8, 1), ('data1', 32, 1), ('data2', 32, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.RMPPVersion & 0xFF) << 24) | ((self.RMPPType & 0xFF) << 16) | ((self.RRespTime & 0x1F) << 11) | (
                (self.RMPPFlags & 0x7) << 8) | ((self.RMPPStatus & 0xFF) << 0)
...
class SMPLIDPortBlock(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_0_32(self):
        return ((self.LID & 0xFFFF) << 16) | ((self.valid & 0x1) << 15) | ((self.LMC & 0x7) << 12) | (
                (self.reserved_20 & 0xF) << 8) | ((self.port & 0xFF) << 0)
...
class SMPNodeInfo(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>BBBB', buffer, offset + 0, self.baseVersion, self.classVersion, self.nodeType,
                         self.numPorts)
        struct.pack_into('>HHLL', buffer, offset + 28, self.partitionCap, self.deviceID, self.revision,
                         self._pack_0_32)
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.baseVersion, self.classVersion, self.nodeType, self.numPorts,) = struct.unpack_from('>BBBB', buffer,
                                                                                                  offset + 0)
        (self.partitionCap, self.deviceID, self.revision, self._pack_0_32,) = struct.unpack_from('>HHLL', buffer,
                                                                                                 offset + 28)
...
class SMPSwitchInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'linearFDBCap', 'randomFDBCap', 'multicastFDBCap', 'linearFDBTop', 'defaultPort', 'defaultMulticastPrimaryPort',
    'defaultMulticastNotPrimaryPort', 'lifeTimeValue', 'portStateChange', 'optimizedSLtoVLMappingProgramming',
    'LIDsPerPort', 'partitionEnforcementCap', 'inboundEnforcementCap', 'outboundEnforcementCap', 'filterRawInboundCap',
    'filterRawOutboundCap', 'enhancedPort0', 'reserved_133', 'reserved_136', 'multicastFDBTop')
    MAD_LENGTH = 20
    MAD_ATTRIBUTE_ID = 0x12
    MAD_SUBNGET = 0x1  # MAD_METHOD_GET
    MAD_SUBNSET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('linearFDBCap', 16, 1), ('randomFDBCap', 16, 1), ('multicastFDBCap', 16, 1), ('linearFDBTop', 16, 1),
               ('defaultPort', 8, 1), ('defaultMulticastPrimaryPort', 8, 1), ('defaultMulticastNotPrimaryPort', 8, 1),
               ('lifeTimeValue', 5, 1), ('portStateChange', 1, 1), ('optimizedSLtoVLMappingProgramming', 2, 1),
               ('LIDsPerPort', 16, 1), ('partitionEnforcementCap', 16, 1), ('inboundEnforcementCap', 1, 1),
               ('outboundEnforcementCap', 1, 1), ('filterRawInboundCap', 1, 1), ('filterRawOutboundCap', 1, 1),
               ('enhancedPort0', 1, 1), ('reserved_133', 3, 1), ('reserved_136', 8, 1), ('multicastFDBTop', 16, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.defaultPort & 0xFF) << 24) | ((self.defaultMulticastPrimaryPort & 0xFF) << 16) | (
                (self.defaultMulticastNotPrimaryPort & 0xFF) << 8) | ((self.lifeTimeValue & 0x1F) << 3) | (
                       (self.portStateChange & 0x1) << 2) | ((self.optimizedSLtoVLMappingProgramming & 0x3) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.inboundEnforcementCap & 0x1) << 31) | ((self.outboundEnforcementCap & 0x1) << 30) | (
                (self.filterRawInboundCap & 0x1) << 29) | ((self.filterRawOutboundCap & 0x1) << 28) | (
                       (self.enhancedPort0 & 0x1) << 27) | ((self.reserved_133 & 0x7) << 24) | (
                       (self.reserved_136 & 0xFF) << 16) | ((self.multicastFDBTop & 0xFFFF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>HHHHLHHL', buffer, offset + 0, self.linearFDBCap, self.randomFDBCap, self.multicastFDBCap,
                         self.linearFDBTop, self._pack_0_32, self.LIDsPerPort, self.partitionEnforcementCap,
                         self._pack_1_32)

    def unpack_from(self, buffer, offset=0):
        (self.linearFDBCap, self.randomFDBCap, self.multicastFDBCap, self.linearFDBTop, self._pack_0_32,
         self.LIDsPerPort, self.partitionEnforcementCap, self._pack_1_32,) = struct.unpack_from('>HHHHLHHL', buffer,
                                                                                                offset + 0)
...
class SMPPortInfo(rdma.binstruct.BinStruct):
    ...
    'initTypeReply', 'MTUCap', 'VLStallCount', 'HOQLife', 'operationalVLs', 'partitionEnforcementInbound',
    'partitionEnforcementOutbound', 'filterRawInbound', 'filterRawOutbound', 'MKeyViolations', 'PKeyViolations',
    'QKeyViolations', 'GUIDCap', 'clientReregister', 'multicastPKeyTrapSuppressionEnabled', 'subnetTimeOut',
    'reserved_416', 'respTimeValue', 'localPhyErrors', 'overrunErrors', 'maxCreditHint', 'reserved_448',
    'linkRoundTripLatency', 'capabilityMask2', 'linkSpeedExtActive', 'linkSpeedExtSupported', 'reserved_504',
    'linkSpeedExtEnabled')
    MAD_LENGTH = 64
    MAD_ATTRIBUTE_ID = 0x15
    MAD_SUBNGET = 0x1  # MAD_METHOD_GET
    ...
    MEMBERS = [('MKey', 64, 1), ('GIDPrefix', 64, 1), ('LID', 16, 1), ('masterSMLID', 16, 1), ('capabilityMask', 32, 1),
               ...
               ('linkSpeedEnabled', 4, 1), ('neighborMTU', 4, 1), ('masterSMSL', 4, 1), ('VLCap', 4, 1),
               ('initType', 4, 1), ('VLHighLimit', 8, 1), ('VLArbitrationHighCap', 8, 1), ('VLArbitrationLowCap', 8, 1),
               ('initTypeReply', 4, 1), ('MTUCap', 4, 1), ('VLStallCount', 3, 1), ('HOQLife', 5, 1),
               ('operationalVLs', 4, 1), ('partitionEnforcementInbound', 1, 1), ('partitionEnforcementOutbound', 1, 1),
               ('filterRawInbound', 1, 1), ('filterRawOutbound', 1, 1), ('MKeyViolations', 16, 1),
               ('PKeyViolations', 16, 1), ('QKeyViolations', 16, 1), ('GUIDCap', 8, 1), ('clientReregister', 1, 1),
               ('multicastPKeyTrapSuppressionEnabled', 2, 1), ('subnetTimeOut', 5, 1), ('reserved_416', 3, 1),
               ('respTimeValue', 5, 1), ('localPhyErrors', 4, 1), ('overrunErrors', 4, 1), ('maxCreditHint', 16, 1),
               ('reserved_448', 8, 1), ('linkRoundTripLatency', 24, 1), ('capabilityMask2', 16, 1),
               ('linkSpeedExtActive', 4, 1), ('linkSpeedExtSupported', 4, 1), ('reserved_504', 3, 1),
               ('linkSpeedExtEnabled', 5, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.linkSpeedSupported & 0xF) << 28) | ((self.portState & 0xF) << 24) | (
                (self.portPhysicalState & 0xF) << 20) | ((self.linkDownDefaultState & 0xF) << 16) | (
                       (self.MKeyProtectBits & 0x3) << 14) | ((self.reserved_274 & 0x7) << 11) | (
                       (self.LMC & 0x7) << 8) | ((self.linkSpeedActive & 0xF) << 4) | (
                       (self.linkSpeedEnabled & 0xF) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.neighborMTU & 0xF) << 28) | ((self.masterSMSL & 0xF) << 24) | ((self.VLCap & 0xF) << 20) | (
                (self.initType & 0xF) << 16) | ((self.VLHighLimit & 0xFF) << 8) | (
                       (self.VLArbitrationHighCap & 0xFF) << 0)
    ...
    @property
    def _pack_2_32(self):
        return ((self.VLArbitrationLowCap & 0xFF) << 24) | ((self.initTypeReply & 0xF) << 20) | (
                (self.MTUCap & 0xF) << 16) | ((self.VLStallCount & 0x7) << 13) | ((self.HOQLife & 0x1F) << 8) | (
                       (self.operationalVLs & 0xF) << 4) | ((self.partitionEnforcementInbound & 0x1) << 3) | (
                       (self.partitionEnforcementOutbound & 0x1) << 2) | ((self.filterRawInbound & 0x1) << 1) | (
                       (self.filterRawOutbound & 0x1) << 0)
    ...
    @property
    def _pack_3_32(self):
        return ((self.QKeyViolations & 0xFFFF) << 16) | ((self.GUIDCap & 0xFF) << 8) | (
                (self.clientReregister & 0x1) << 7) | ((self.multicastPKeyTrapSuppressionEnabled & 0x3) << 5) | (
                       (self.subnetTimeOut & 0x1F) << 0)
    ...
    @property
    def _pack_4_32(self):
        return ((self.reserved_416 & 0x7) << 29) | ((self.respTimeValue & 0x1F) << 24) | (
                (self.localPhyErrors & 0xF) << 20) | ((self.overrunErrors & 0xF) << 16) | (
                       (self.maxCreditHint & 0xFFFF) << 0)
    ...
    @property
    def _pack_6_32(self):
        return ((self.capabilityMask2 & 0xFFFF) << 16) | ((self.linkSpeedExtActive & 0xF) << 12) | (
                (self.linkSpeedExtSupported & 0xF) << 8) | ((self.reserved_504 & 0x7) << 5) | (
                       (self.linkSpeedExtEnabled & 0x1F) << 0)
...
class SMPPKeyTable(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.PKeyBlock[0], self.PKeyBlock[1],
                         self.PKeyBlock[2], self.PKeyBlock[3], self.PKeyBlock[4], self.PKeyBlock[5], self.PKeyBlock[6],
                         self.PKeyBlock[7], self.PKeyBlock[8], self.PKeyBlock[9], self.PKeyBlock[10],
                         self.PKeyBlock[11], self.PKeyBlock[12], self.PKeyBlock[13], self.PKeyBlock[14],
                         self.PKeyBlock[15], self.PKeyBlock[16], self.PKeyBlock[17], self.PKeyBlock[18],
                         self.PKeyBlock[19], self.PKeyBlock[20], self.PKeyBlock[21], self.PKeyBlock[22],
                         self.PKeyBlock[23], self.PKeyBlock[24], self.PKeyBlock[25], self.PKeyBlock[26],
                         self.PKeyBlock[27], self.PKeyBlock[28], self.PKeyBlock[29], self.PKeyBlock[30],
                         self.PKeyBlock[31])

    def unpack_from(self, buffer, offset=0):
        (self.PKeyBlock[0], self.PKeyBlock[1], self.PKeyBlock[2], self.PKeyBlock[3], self.PKeyBlock[4],
         self.PKeyBlock[5], self.PKeyBlock[6], self.PKeyBlock[7], self.PKeyBlock[8], self.PKeyBlock[9],
         self.PKeyBlock[10], self.PKeyBlock[11], self.PKeyBlock[12], self.PKeyBlock[13], self.PKeyBlock[14],
         self.PKeyBlock[15], self.PKeyBlock[16], self.PKeyBlock[17], self.PKeyBlock[18], self.PKeyBlock[19],
         self.PKeyBlock[20], self.PKeyBlock[21], self.PKeyBlock[22], self.PKeyBlock[23], self.PKeyBlock[24],
         self.PKeyBlock[25], self.PKeyBlock[26], self.PKeyBlock[27], self.PKeyBlock[28], self.PKeyBlock[29],
         self.PKeyBlock[30], self.PKeyBlock[31],) = struct.unpack_from('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer,
                                                                       offset + 0)
...
class SMPVLArbitrationTable(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.VLWeightBlock[0],
                         self.VLWeightBlock[1], self.VLWeightBlock[2], self.VLWeightBlock[3], self.VLWeightBlock[4],
                         self.VLWeightBlock[5], self.VLWeightBlock[6], self.VLWeightBlock[7], self.VLWeightBlock[8],
                         self.VLWeightBlock[9], self.VLWeightBlock[10], self.VLWeightBlock[11], self.VLWeightBlock[12],
                         self.VLWeightBlock[13], self.VLWeightBlock[14], self.VLWeightBlock[15], self.VLWeightBlock[16],
                         self.VLWeightBlock[17], self.VLWeightBlock[18], self.VLWeightBlock[19], self.VLWeightBlock[20],
                         self.VLWeightBlock[21], self.VLWeightBlock[22], self.VLWeightBlock[23], self.VLWeightBlock[24],
                         self.VLWeightBlock[25], self.VLWeightBlock[26], self.VLWeightBlock[27], self.VLWeightBlock[28],
                         self.VLWeightBlock[29], self.VLWeightBlock[30], self.VLWeightBlock[31])

    def unpack_from(self, buffer, offset=0):
        (self.VLWeightBlock[0], self.VLWeightBlock[1], self.VLWeightBlock[2], self.VLWeightBlock[3],
         self.VLWeightBlock[4], self.VLWeightBlock[5], self.VLWeightBlock[6], self.VLWeightBlock[7],
         self.VLWeightBlock[8], self.VLWeightBlock[9], self.VLWeightBlock[10], self.VLWeightBlock[11],
         self.VLWeightBlock[12], self.VLWeightBlock[13], self.VLWeightBlock[14], self.VLWeightBlock[15],
         self.VLWeightBlock[16], self.VLWeightBlock[17], self.VLWeightBlock[18], self.VLWeightBlock[19],
         self.VLWeightBlock[20], self.VLWeightBlock[21], self.VLWeightBlock[22], self.VLWeightBlock[23],
         self.VLWeightBlock[24], self.VLWeightBlock[25], self.VLWeightBlock[26], self.VLWeightBlock[27],
         self.VLWeightBlock[28], self.VLWeightBlock[29], self.VLWeightBlock[30],
         self.VLWeightBlock[31],) = struct.unpack_from('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0)
...
class SMPMulticastForwardingTable(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.portMaskBlock[0],
                         self.portMaskBlock[1], self.portMaskBlock[2], self.portMaskBlock[3], self.portMaskBlock[4],
                         self.portMaskBlock[5], self.portMaskBlock[6], self.portMaskBlock[7], self.portMaskBlock[8],
                         self.portMaskBlock[9], self.portMaskBlock[10], self.portMaskBlock[11], self.portMaskBlock[12],
                         self.portMaskBlock[13], self.portMaskBlock[14], self.portMaskBlock[15], self.portMaskBlock[16],
                         self.portMaskBlock[17], self.portMaskBlock[18], self.portMaskBlock[19], self.portMaskBlock[20],
                         self.portMaskBlock[21], self.portMaskBlock[22], self.portMaskBlock[23], self.portMaskBlock[24],
                         self.portMaskBlock[25], self.portMaskBlock[26], self.portMaskBlock[27], self.portMaskBlock[28],
                         self.portMaskBlock[29], self.portMaskBlock[30], self.portMaskBlock[31])

    def unpack_from(self, buffer, offset=0):
        (self.portMaskBlock[0], self.portMaskBlock[1], self.portMaskBlock[2], self.portMaskBlock[3],
         self.portMaskBlock[4], self.portMaskBlock[5], self.portMaskBlock[6], self.portMaskBlock[7],
         self.portMaskBlock[8], self.portMaskBlock[9], self.portMaskBlock[10], self.portMaskBlock[11],
         self.portMaskBlock[12], self.portMaskBlock[13], self.portMaskBlock[14], self.portMaskBlock[15],
         self.portMaskBlock[16], self.portMaskBlock[17], self.portMaskBlock[18], self.portMaskBlock[19],
         self.portMaskBlock[20], self.portMaskBlock[21], self.portMaskBlock[22], self.portMaskBlock[23],
         self.portMaskBlock[24], self.portMaskBlock[25], self.portMaskBlock[26], self.portMaskBlock[27],
         self.portMaskBlock[28], self.portMaskBlock[29], self.portMaskBlock[30],
         self.portMaskBlock[31],) = struct.unpack_from('>HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0)
...
class SMPSMInfo(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNGET = 0x1  # MAD_METHOD_GET
    MAD_SUBNSET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('GUID', 64, 1), ('SMKey', 64, 1), ('actCount', 32, 1), ('priority', 4, 1), ('SMState', 4, 1),
               ('reserved_168', 24, 1)]
...
class SMPNoticeTrap(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'isGeneric', 'noticeType', 'nodeType', 'trapNumber', 'issuerLID', 'noticeToggle', 'noticeCount', 'dataDetails',
    'dataDetails2')
    MAD_LENGTH = 64
    MAD_ATTRIBUTE_ID = 0x2
    MAD_SUBNTRAP = 0x5  # MAD_METHOD_TRAP
    MAD_SUBNTRAPREPRESS = 0x7  # MAD_METHOD_TRAP_REPRESS
    MEMBERS = [('isGeneric', 1, 1), ('noticeType', 7, 1), ('nodeType', 24, 1), ('trapNumber', 16, 1),
               ('issuerLID', 16, 1), ('noticeToggle', 1, 1), ('noticeCount', 15, 1), ('dataDetails', 16, 1),
               ('dataDetails2', 16, 26)]
    ...
    @property
    def _pack_1_32(self):
        return ((self.noticeToggle & 0x1) << 31) | ((self.noticeCount & 0x7FFF) << 16) | (
                (self.dataDetails & 0xFFFF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>LHHLHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer, offset + 0, self._pack_0_32, self.trapNumber,
                         self.issuerLID, self._pack_1_32, self.dataDetails2[0], self.dataDetails2[1],
                         self.dataDetails2[2], self.dataDetails2[3], self.dataDetails2[4], self.dataDetails2[5],
                         self.dataDetails2[6], self.dataDetails2[7], self.dataDetails2[8], self.dataDetails2[9],
                         self.dataDetails2[10], self.dataDetails2[11], self.dataDetails2[12], self.dataDetails2[13],
                         self.dataDetails2[14], self.dataDetails2[15], self.dataDetails2[16], self.dataDetails2[17],
                         self.dataDetails2[18], self.dataDetails2[19], self.dataDetails2[20], self.dataDetails2[21],
                         self.dataDetails2[22], self.dataDetails2[23], self.dataDetails2[24], self.dataDetails2[25])

    def unpack_from(self, buffer, offset=0):
        (self._pack_0_32, self.trapNumber, self.issuerLID, self._pack_1_32, self.dataDetails2[0], self.dataDetails2[1],
         self.dataDetails2[2], self.dataDetails2[3], self.dataDetails2[4], self.dataDetails2[5], self.dataDetails2[6],
         self.dataDetails2[7], self.dataDetails2[8], self.dataDetails2[9], self.dataDetails2[10], self.dataDetails2[11],
         self.dataDetails2[12], self.dataDetails2[13], self.dataDetails2[14], self.dataDetails2[15],
         self.dataDetails2[16], self.dataDetails2[17], self.dataDetails2[18], self.dataDetails2[19],
         self.dataDetails2[20], self.dataDetails2[21], self.dataDetails2[22], self.dataDetails2[23],
         self.dataDetails2[24], self.dataDetails2[25],) = struct.unpack_from('>LHHLHHHHHHHHHHHHHHHHHHHHHHHHHH', buffer,
                                                                             offset + 0)
...
class SAPortInfoRecord(rdma.binstruct.BinStruct):
    ...
    COMPONENT_MASK = {
        ...
        'portInfo.linkSpeedEnabled': 22, 'portInfo.neighborMTU': 23, 'portInfo.masterSMSL': 24, 'portInfo.VLCap': 25,
        'portInfo.initType': 26, 'portInfo.VLHighLimit': 27, 'portInfo.VLArbitrationHighCap': 28,
        'portInfo.VLArbitrationLowCap': 29, 'portInfo.initTypeReply': 30, 'portInfo.MTUCap': 31,
        'portInfo.VLStallCount': 32, 'portInfo.HOQLife': 33, 'portInfo.operationalVLs': 34,
        'portInfo.partitionEnforcementInbound': 35, 'portInfo.partitionEnforcementOutbound': 36,
        'portInfo.filterRawInbound': 37, 'portInfo.filterRawOutbound': 38, 'portInfo.MKeyViolations': 39,
        'portInfo.PKeyViolations': 40, 'portInfo.QKeyViolations': 41, 'portInfo.GUIDCap': 42,
        'portInfo.clientReregister': 43, 'portInfo.multicastPKeyTrapSuppressionEnabled': 44,
        'portInfo.subnetTimeOut': 45, 'portInfo.reserved_416': 46, 'portInfo.respTimeValue': 47,
        'portInfo.localPhyErrors': 48, 'portInfo.overrunErrors': 49, 'portInfo.maxCreditHint': 50,
        'portInfo.reserved_448': 51, 'portInfo.linkRoundTripLatency': 52, 'portInfo.capabilityMask2': 53,
        'portInfo.linkSpeedExtActive': 54, 'portInfo.linkSpeedExtSupported': 55, 'portInfo.reserved_504': 56,
        'portInfo.linkSpeedExtEnabled': 57
    }
...
class SASLToVLMappingTableRecord(rdma.binstruct.BinStruct):
    ...
    MEMBERS = [('LID', 16, 1), ('inputPortNum', 8, 1), ('outputPortNum', 8, 1), ('reserved_32', 32, 1),
               ('SLToVLMappingTable', 64, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>HBBL', buffer, offset + 0, self.LID, self.inputPortNum, self.outputPortNum,
                         self.reserved_32)

    def unpack_from(self, buffer, offset=0):
        self.SLToVLMappingTable.unpack_from(buffer, offset + 8)
        (self.LID, self.inputPortNum, self.outputPortNum, self.reserved_32,) = struct.unpack_from('>HBBL', buffer,
                                                                                                  offset + 0)
...
class SASwitchInfoRecord(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'LID': 0, 'reserved_16': 1, 'switchInfo.linearFDBCap': 2, 'switchInfo.randomFDBCap': 3,
        'switchInfo.multicastFDBCap': 4, 'switchInfo.linearFDBTop': 5, 'switchInfo.defaultPort': 6,
        'switchInfo.defaultMulticastPrimaryPort': 7, 'switchInfo.defaultMulticastNotPrimaryPort': 8,
        'switchInfo.lifeTimeValue': 9, 'switchInfo.portStateChange': 10,
        'switchInfo.optimizedSLtoVLMappingProgramming': 11, 'switchInfo.LIDsPerPort': 12,
        'switchInfo.partitionEnforcementCap': 13, 'switchInfo.inboundEnforcementCap': 14,
        'switchInfo.outboundEnforcementCap': 15, 'switchInfo.filterRawInboundCap': 16,
        'switchInfo.filterRawOutboundCap': 17, 'switchInfo.enhancedPort0': 18, 'switchInfo.reserved_133': 19,
        'switchInfo.reserved_136': 20, 'switchInfo.multicastFDBTop': 21
    }
...
class SAMulticastForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'LID': 0, 'reserved_16': 1, 'position': 2, 'blockNum': 3, 'reserved_32': 4,
        'multicastForwardingTable.portMaskBlock': 5
    }
    MEMBERS = [('LID', 16, 1), ('reserved_16', 2, 1), ('position', 4, 1), ('blockNum', 10, 1), ('reserved_32', 32, 1),
               ('multicastForwardingTable', 512, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.LID & 0xFFFF) << 16) | ((self.reserved_16 & 0x3) << 14) | ((self.position & 0xF) << 10) | (
                (self.blockNum & 0x3FF) << 0)
...
class SAVLArbitrationTableRecord(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'LID': 0, 'outputPortNum': 1, 'blockNum': 2, 'reserved_32': 3, 'VLArbitrationTable.VLWeightBlock': 4
    }
    MEMBERS = [('LID', 16, 1), ('outputPortNum', 8, 1), ('blockNum', 8, 1), ('reserved_32', 32, 1),
               ('VLArbitrationTable', 512, 1)]
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.LID, self.outputPortNum, self.blockNum, self.reserved_32,) = struct.unpack_from('>HBBL', buffer,
                                                                                              offset + 0)
...
class SASMInfoRecord(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'LID': 0, 'reserved_16': 1, 'SMInfo.GUID': 2, 'SMInfo.SMKey': 3, 'SMInfo.actCount': 4, 'SMInfo.priority': 5,
        'SMInfo.SMState': 6, 'SMInfo.reserved_168': 7
    }
...
class SAInformInfoRecord(rdma.binstruct.BinStruct):
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'subscriberGID': 0, 'enumeration': 1, 'reserved_144': 2, 'informInfo.GID': 3, 'informInfo.LIDRangeBegin': 4,
        'informInfo.LIDRangeEnd': 5, 'informInfo.reserved_160': 6, 'informInfo.isGeneric': 7, 'informInfo.subscribe': 8,
        'informInfo.type': 9, 'informInfo.trapNumber': 10, 'informInfo.QPN': 11, 'informInfo.reserved_248': 12,
        'informInfo.respTimeValue': 13, 'informInfo.reserved_256': 14, 'informInfo.producerType': 15, 'reserved_480': 16
    }
    MEMBERS = [('subscriberGID', 128, 1), ('enumeration', 16, 1), ('reserved_144', 16, 1), ('reserved_160', 32, 1),
               ('informInfo', 288, 1), ('reserved_480', 160, 1)]
...
class SAGUIDInfoRecord(rdma.binstruct.BinStruct):
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.LID, self.blockNum, self.reserved_24, self.reserved_32,) = struct.unpack_from('>HBBL', buffer,
                                                                                            offset + 0)


class SAServiceRecord(rdma.binstruct.BinStruct):
    """Information on advertised services (section 15.2.5.14)"""
    __slots__ = ('serviceID', 'serviceGID', 'servicePKey', 'reserved_208', 'serviceLease', 'serviceKey', 'serviceName',
                 'serviceData8', 'serviceData16', 'serviceData32', 'serviceData64')
    MAD_LENGTH = 176
    MAD_ATTRIBUTE_ID = 0x31
    MAD_SUBNADMDELETE = 0x15  # MAD_METHOD_DELETE
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
    ...
    MAD_SUBNADMSET = 0x2  # MAD_METHOD_SET
    COMPONENT_MASK = {
        'serviceID': 0, 'serviceGID': 1, 'servicePKey': 2, 'reserved_208': 3, 'serviceLease': 4, 'serviceKey': 5,
        'serviceName': 6, 'serviceData8_0': 7, 'serviceData8_1': 8, 'serviceData8_2': 9, 'serviceData8_3': 10,
        'serviceData8_4': 11, 'serviceData8_5': 12, 'serviceData8_6': 13, 'serviceData8_7': 14, 'serviceData8_8': 15,
        'serviceData8_9': 16, 'serviceData8_10': 17, 'serviceData8_11': 18, 'serviceData8_12': 19,
        'serviceData8_13': 20, 'serviceData8_14': 21, 'serviceData8_15': 22, 'serviceData16_0': 23,
        'serviceData16_1': 24, 'serviceData16_2': 25, 'serviceData16_3': 26, 'serviceData16_4': 27,
        'serviceData16_5': 28, 'serviceData16_6': 29, 'serviceData16_7': 30, 'serviceData32_0': 31,
        'serviceData32_1': 32, 'serviceData32_2': 33, 'serviceData32_3': 34, 'serviceData64_0': 35,
        'serviceData64_1': 36
    }
    MEMBERS = [('serviceID', 64, 1), ('serviceGID', 128, 1), ('servicePKey', 16, 1), ('reserved_208', 16, 1),
               ('serviceLease', 32, 1), ('serviceKey', 128, 1), ('serviceName', 8, 64), ('serviceData8', 8, 16),
               ('serviceData16', 16, 8), ('serviceData32', 32, 4), ('serviceData64', 64, 2)]
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>HHHHHHHHLLLL', buffer, offset + 128, self.serviceData16[0], self.serviceData16[1],
                         self.serviceData16[2], self.serviceData16[3], self.serviceData16[4], self.serviceData16[5],
                         self.serviceData16[6], self.serviceData16[7], self.serviceData32[0], self.serviceData32[1],
                         self.serviceData32[2], self.serviceData32[3])
    ...
    def unpack_from(self, buffer, offset=0):
        ...
        (self.serviceData16[0], self.serviceData16[1], self.serviceData16[2], self.serviceData16[3],
         self.serviceData16[4], self.serviceData16[5], self.serviceData16[6], self.serviceData16[7],
         self.serviceData32[0], self.serviceData32[1], self.serviceData32[2],
         self.serviceData32[3],) = struct.unpack_from('>HHHHHHHHLLLL', buffer, offset + 128)
...
class SAPathRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'serviceID', 'DGID', 'SGID', 'DLID', 'SLID', 'rawTraffic', 'reserved_353', 'flowLabel', 'hopLimit', 'TClass',
    'reversible', 'numbPath', 'PKey', 'QOSClass', 'SL', 'MTUSelector', 'MTU', 'rateSelector', 'rate',
    'packetLifeTimeSelector', 'packetLifeTime', 'preference', 'reversePathPKeyMemberBit', 'reserved_466',
    'reserved_480')
    MAD_LENGTH = 64
    ...
    MAD_SUBNADMGETTABLE = 0x12  # MAD_METHOD_GET_TABLE
    COMPONENT_MASK = {
        'serviceID': 0, 'serviceID56LSB': 1, 'DGID': 2, 'SGID': 3, 'DLID': 4, 'SLID': 5, 'rawTraffic': 6,
        'reserved_353': 7, 'flowLabel': 8, 'hopLimit': 9, 'TClass': 10, 'reversible': 11, 'numbPath': 12, 'PKey': 13,
        'QOSClass': 14, 'SL': 15, 'MTUSelector': 16, 'MTU': 17, 'rateSelector': 18, 'rate': 19,
        'packetLifeTimeSelector': 20, 'packetLifeTime': 21, 'preference': 22, 'reversePathPKeyMemberBit': 23,
        'reserved_466': 24, 'reserved_480': 25
    }
    MEMBERS = [('serviceID', 64, 1), ('DGID', 128, 1), ('SGID', 128, 1), ('DLID', 16, 1), ('SLID', 16, 1),
               ('rawTraffic', 1, 1), ('reserved_353', 3, 1), ('flowLabel', 20, 1), ('hopLimit', 8, 1), ('TClass', 8, 1),
               ('reversible', 1, 1), ('numbPath', 7, 1), ('PKey', 16, 1), ('QOSClass', 12, 1), ('SL', 4, 1),
               ('MTUSelector', 2, 1), ('MTU', 6, 1), ('rateSelector', 2, 1), ('rate', 6, 1),
               ('packetLifeTimeSelector', 2, 1), ('packetLifeTime', 6, 1), ('preference', 8, 1),
               ('reversePathPKeyMemberBit', 2, 1), ('reserved_466', 14, 1), ('reserved_480', 32, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.rawTraffic & 0x1) << 31) | ((self.reserved_353 & 0x7) << 28) | (
                (self.flowLabel & 0xFFFFF) << 8) | ((self.hopLimit & 0xFF) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.TClass & 0xFF) << 24) | ((self.reversible & 0x1) << 23) | ((self.numbPath & 0x7F) << 16) | (
                (self.PKey & 0xFFFF) << 0)
    ...
    @property
    def _pack_2_32(self):
        return ((self.QOSClass & 0xFFF) << 20) | ((self.SL & 0xF) << 16) | ((self.MTUSelector & 0x3) << 14) | (
                (self.MTU & 0x3F) << 8) | ((self.rateSelector & 0x3) << 6) | ((self.rate & 0x3F) << 0)
    ...
    @property
    def _pack_3_32(self):
        return ((self.packetLifeTimeSelector & 0x3) << 30) | ((self.packetLifeTime & 0x3F) << 24) | (
                (self.preference & 0xFF) << 16) | ((self.reversePathPKeyMemberBit & 0x3) << 14) | (
                       (self.reserved_466 & 0x3FFF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>Q', buffer, offset + 0, self.serviceID)
        struct.pack_into('>HHLLLLL', buffer, offset + 40, self.DLID, self.SLID, self._pack_0_32, self._pack_1_32,
                         self._pack_2_32, self._pack_3_32, self.reserved_480)

    def unpack_from(self, buffer, offset=0):
        self.DGID = IBA.GID(buffer[offset + 8:offset + 24], raw=True)
        self.SGID = IBA.GID(buffer[offset + 24:offset + 40], raw=True)
        (self.serviceID,) = struct.unpack_from('>Q', buffer, offset + 0)
        (self.DLID, self.SLID, self._pack_0_32, self._pack_1_32, self._pack_2_32, self._pack_3_32,
         self.reserved_480,) = struct.unpack_from('>HHLLLLL', buffer, offset + 40)


class SAMCMemberRecord(rdma.binstruct.BinStruct):
    """Multicast member attribute (section 15.2.5.17)"""
    __slots__ = ('MGID', 'portGID', 'QKey', 'MLID', 'MTUSelector', 'MTU', 'TClass', 'PKey', 'rateSelector', 'rate',
                 'packetLifeTimeSelector', 'packetLifeTime', 'SL', 'flowLabel', 'hopLimit', 'scope', 'joinState',
                 'proxyJoin', 'reserved_393')
    MAD_LENGTH = 52
    ...
    MAD_SUBNADMSET = 0x2  # MAD_METHOD_SET
    COMPONENT_MASK = {
        'MGID': 0, 'portGID': 1, 'QKey': 2, 'MLID': 3, 'MTUSelector': 4, 'MTU': 5, 'TClass': 6, 'PKey': 7,
        'rateSelector': 8, 'rate': 9, 'packetLifeTimeSelector': 10, 'packetLifeTime': 11, 'SL': 12, 'flowLabel': 13,
        'hopLimit': 14, 'scope': 15, 'joinState': 16, 'proxyJoin': 17, 'reserved_393': 18
    }
    MEMBERS = [('MGID', 128, 1), ('portGID', 128, 1), ('QKey', 32, 1), ('MLID', 16, 1), ('MTUSelector', 2, 1),
               ('MTU', 6, 1), ('TClass', 8, 1), ('PKey', 16, 1), ('rateSelector', 2, 1), ('rate', 6, 1),
               ('packetLifeTimeSelector', 2, 1), ('packetLifeTime', 6, 1), ('SL', 4, 1), ('flowLabel', 20, 1),
               ('hopLimit', 8, 1), ('scope', 4, 1), ('joinState', 4, 1), ('proxyJoin', 1, 1), ('reserved_393', 23, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.MLID & 0xFFFF) << 16) | ((self.MTUSelector & 0x3) << 14) | ((self.MTU & 0x3F) << 8) | (
                (self.TClass & 0xFF) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.PKey & 0xFFFF) << 16) | ((self.rateSelector & 0x3) << 14) | ((self.rate & 0x3F) << 8) | (
                (self.packetLifeTimeSelector & 0x3) << 6) | ((self.packetLifeTime & 0x3F) << 0)
    ...
    @property
    def _pack_3_32(self):
        return ((self.scope & 0xF) << 28) | ((self.joinState & 0xF) << 24) | ((self.proxyJoin & 0x1) << 23) | (
                (self.reserved_393 & 0x7FFFFF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLLL', buffer, offset + 32, self.QKey, self._pack_0_32, self._pack_1_32, self._pack_2_32,
                         self._pack_3_32)

    def unpack_from(self, buffer, offset=0):
        self.MGID = IBA.GID(buffer[offset + 0:offset + 16], raw=True)
        self.portGID = IBA.GID(buffer[offset + 16:offset + 32], raw=True)
        (self.QKey, self._pack_0_32, self._pack_1_32, self._pack_2_32, self._pack_3_32,) = struct.unpack_from('>LLLLL',
                                                                                                              buffer,
                                                                                                              offset + 32)
...
class SATraceRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'GIDPrefix', 'IDGeneration', 'reserved_80', 'nodeType', 'nodeID', 'chassisID', 'entryPortID', 'exitPortID',
    'entryPort', 'exitPort', 'reserved_368')
    MAD_LENGTH = 48
    MAD_ATTRIBUTE_ID = 0x39
    MAD_SUBNADMGETTRACETABLE = 0x13  # MAD_METHOD_GET_TRACE_TABLE
    COMPONENT_MASK = {
        'GIDPrefix': 0, 'IDGeneration': 1, 'reserved_80': 2, 'nodeType': 3, 'nodeID': 4, 'chassisID': 5,
        'entryPortID': 6, 'exitPortID': 7, 'entryPort': 8, 'exitPort': 9, 'reserved_368': 10
    }
    MEMBERS = [('GIDPrefix', 64, 1), ('IDGeneration', 16, 1), ('reserved_80', 8, 1), ('nodeType', 8, 1),
               ('nodeID', 64, 1), ('chassisID', 64, 1), ('entryPortID', 64, 1), ('exitPortID', 64, 1),
               ('entryPort', 8, 1), ('exitPort', 8, 1), ('reserved_368', 16, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>QHBBQQQQBBH', buffer, offset + 0, self.GIDPrefix, self.IDGeneration, self.reserved_80,
                         self.nodeType, self.nodeID, self.chassisID, self.entryPortID, self.exitPortID, self.entryPort,
                         self.exitPort, self.reserved_368)

    def unpack_from(self, buffer, offset=0):
        (self.GIDPrefix, self.IDGeneration, self.reserved_80, self.nodeType, self.nodeID, self.chassisID,
         self.entryPortID, self.exitPortID, self.entryPort, self.exitPort, self.reserved_368,) = struct.unpack_from(
            '>QHBBQQQQBBH', buffer, offset + 0)


class SAMultiPathRecord(rdma.binstruct.BinStruct):
    """Request for multiple paths (section 15.2.5.20)"""
    __slots__ = (
    'rawTraffic', 'reserved_1', 'flowLabel', 'hopLimit', 'TClass', 'reversible', 'numbPath', 'PKey', 'reserved_64',
    'SL', 'MTUSelector', 'MTU', 'rateSelector', 'rate', 'packetLifeTimeSelector', 'packetLifeTime', 'reserved_104',
    'independenceSelector', 'reserved_114', 'SGIDCount', 'DGIDCount', 'reserved_136', 'reserved_160', 'SDGID')
    MAD_LENGTH = 40
    MAD_ATTRIBUTE_ID = 0x3a
    MAD_SUBNADMGETMULTI = 0x14  # MAD_METHOD_GET_MULTI
    COMPONENT_MASK = {
        'rawTraffic': 0, 'reserved_1': 1, 'flowLabel': 2, 'hopLimit': 3, 'TClass': 4, 'reversible': 5, 'numbPath': 6,
        'PKey': 7, 'reserved_64': 8, 'SL': 9, 'MTUSelector': 10, 'MTU': 11, 'rateSelector': 12, 'rate': 13,
        'packetLifeTimeSelector': 14, 'packetLifeTime': 15, 'reserved_104': 16, 'independenceSelector': 17,
        'reserved_114': 18, 'SGIDCount': 19, 'DGIDCount': 20, 'reserved_136': 21, 'reserved_160': 22, 'SDGID': 23
    }
    MEMBERS = [('rawTraffic', 1, 1), ('reserved_1', 3, 1), ('flowLabel', 20, 1), ('hopLimit', 8, 1), ('TClass', 8, 1),
               ('reversible', 1, 1), ('numbPath', 7, 1), ('PKey', 16, 1), ('reserved_64', 12, 1), ('SL', 4, 1),
               ('MTUSelector', 2, 1), ('MTU', 6, 1), ('rateSelector', 2, 1), ('rate', 6, 1),
               ('packetLifeTimeSelector', 2, 1), ('packetLifeTime', 6, 1), ('reserved_104', 8, 1),
               ('independenceSelector', 2, 1), ('reserved_114', 6, 1), ('SGIDCount', 8, 1), ('DGIDCount', 8, 1),
               ('reserved_136', 24, 1), ('reserved_160', 32, 1), ('SDGID', 128, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.rawTraffic & 0x1) << 31) | ((self.reserved_1 & 0x7) << 28) | ((self.flowLabel & 0xFFFFF) << 8) | (
                (self.hopLimit & 0xFF) << 0)
    ...
    @property
    def _pack_2_32(self):
        return ((self.reserved_64 & 0xFFF) << 20) | ((self.SL & 0xF) << 16) | ((self.MTUSelector & 0x3) << 14) | (
                (self.MTU & 0x3F) << 8) | ((self.rateSelector & 0x3) << 6) | ((self.rate & 0x3F) << 0)
    ...
    def _pack_3_32(self):
        return ((self.packetLifeTimeSelector & 0x3) << 30) | ((self.packetLifeTime & 0x3F) << 24) | (
                (self.reserved_104 & 0xFF) << 16) | ((self.independenceSelector & 0x3) << 14) | (
                       (self.reserved_114 & 0x3F) << 8) | ((self.SGIDCount & 0xFF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLLLL', buffer, offset + 0, self._pack_0_32, self._pack_1_32, self._pack_2_32,
                         self._pack_3_32, self._pack_4_32, self.reserved_160)

    def unpack_from(self, buffer, offset=0):
        self.SDGID = IBA.GID(buffer[offset + 24:offset + 40], raw=True)
        (self._pack_0_32, self._pack_1_32, self._pack_2_32, self._pack_3_32, self._pack_4_32,
         self.reserved_160,) = struct.unpack_from('>LLLLLL', buffer, offset + 0)
...
class PMPortSamplesCtl(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'opCode', 'portSelect', 'tick', 'reserved_24', 'counterWidth', 'reserved_32', 'counterMask0', 'counterMask1',
    'counterMask2', 'counterMask3', 'counterMask4', 'counterMask5', 'counterMask6', 'counterMask7', 'counterMask8',
    'counterMask9', 'reserved_64', 'counterMask10', 'counterMask11', 'counterMask12', 'counterMask13', 'counterMask14',
    'sampleMechanisms', 'reserved_88', 'sampleStatus', 'optionMask', 'vendorMask', 'sampleStart', 'sampleInterval',
    'tag', 'counterSelect0', 'counterSelect1', 'counterSelect2', 'counterSelect3', 'counterSelect4', 'counterSelect5',
    'counterSelect6', 'counterSelect7', 'counterSelect8', 'counterSelect9', 'counterSelect10', 'counterSelect11',
    ...
    MEMBERS = [('opCode', 8, 1), ('portSelect', 8, 1), ('tick', 8, 1), ('reserved_24', 5, 1), ('counterWidth', 3, 1),
               ('reserved_32', 2, 1), ('counterMask0', 3, 1), ('counterMask1', 3, 1), ('counterMask2', 3, 1),
               ('counterMask3', 3, 1), ('counterMask4', 3, 1), ('counterMask5', 3, 1), ('counterMask6', 3, 1),
               ('counterMask7', 3, 1), ('counterMask8', 3, 1), ('counterMask9', 3, 1), ('reserved_64', 1, 1),
               ('counterMask10', 3, 1), ('counterMask11', 3, 1), ('counterMask12', 3, 1), ('counterMask13', 3, 1),
               ('counterMask14', 3, 1), ('sampleMechanisms', 8, 1), ('reserved_88', 6, 1), ('sampleStatus', 2, 1),
               ('optionMask', 64, 1), ('vendorMask', 64, 1), ('sampleStart', 32, 1), ('sampleInterval', 32, 1),
               ('tag', 16, 1), ('counterSelect0', 16, 1), ('counterSelect1', 16, 1), ('counterSelect2', 16, 1),
               ('counterSelect3', 16, 1), ('counterSelect4', 16, 1), ('counterSelect5', 16, 1),
               ('counterSelect6', 16, 1), ('counterSelect7', 16, 1), ('counterSelect8', 16, 1),
               ('counterSelect9', 16, 1), ('counterSelect10', 16, 1), ('counterSelect11', 16, 1),
               ('counterSelect12', 16, 1), ('counterSelect13', 16, 1), ('counterSelect14', 16, 1),
               ('reserved_544', 32, 1), ('samplesOnlyOptionMask', 64, 1), ('reserved_640', 896, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.opCode & 0xFF) << 24) | ((self.portSelect & 0xFF) << 16) | ((self.tick & 0xFF) << 8) | (
                (self.reserved_24 & 0x1F) << 3) | ((self.counterWidth & 0x7) << 0)
    ...
    @property
    def _pack_1_32(self):
        return ((self.reserved_32 & 0x3) << 30) | ((self.counterMask0 & 0x7) << 27) | (
                (self.counterMask1 & 0x7) << 24) | ((self.counterMask2 & 0x7) << 21) | (
                       (self.counterMask3 & 0x7) << 18) | ((self.counterMask4 & 0x7) << 15) | (
                       (self.counterMask5 & 0x7) << 12) | ((self.counterMask6 & 0x7) << 9) | (
                       (self.counterMask7 & 0x7) << 6) | ((self.counterMask8 & 0x7) << 3) | (
                       (self.counterMask9 & 0x7) << 0)
    ...
    @property
    def _pack_2_32(self):
        return ((self.reserved_64 & 0x1) << 31) | ((self.counterMask10 & 0x7) << 28) | (
                (self.counterMask11 & 0x7) << 25) | ((self.counterMask12 & 0x7) << 22) | (
                       (self.counterMask13 & 0x7) << 19) | ((self.counterMask14 & 0x7) << 16) | (
                       (self.sampleMechanisms & 0xFF) << 8) | ((self.reserved_88 & 0x3F) << 2) | (
                       (self.sampleStatus & 0x3) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLLQQLLHHHHHHHHHHHHHHHHLQ', buffer, offset + 0, self._pack_0_32, self._pack_1_32,
                         self._pack_2_32, self.optionMask, self.vendorMask, self.sampleStart, self.sampleInterval,
                         self.tag, self.counterSelect0, self.counterSelect1, self.counterSelect2, self.counterSelect3,
                         self.counterSelect4, self.counterSelect5, self.counterSelect6, self.counterSelect7,
                         self.counterSelect8, self.counterSelect9, self.counterSelect10, self.counterSelect11,
                         self.counterSelect12, self.counterSelect13, self.counterSelect14, self.reserved_544,
                         self.samplesOnlyOptionMask)

    def unpack_from(self, buffer, offset=0):
        self.reserved_640 = bytearray(buffer[offset + 80:offset + 192])
        (self._pack_0_32, self._pack_1_32, self._pack_2_32, self.optionMask, self.vendorMask, self.sampleStart,
         self.sampleInterval, self.tag, self.counterSelect0, self.counterSelect1, self.counterSelect2,
         self.counterSelect3, self.counterSelect4, self.counterSelect5, self.counterSelect6, self.counterSelect7,
         self.counterSelect8, self.counterSelect9, self.counterSelect10, self.counterSelect11, self.counterSelect12,
         self.counterSelect13, self.counterSelect14, self.reserved_544,
...
class PMPortSamplesRes(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>LLLLLLLLLLLLLLLL', buffer, offset + 0, self._pack_0_32, self.counter[0], self.counter[1],
                         self.counter[2], self.counter[3], self.counter[4], self.counter[5], self.counter[6],
                         self.counter[7], self.counter[8], self.counter[9], self.counter[10], self.counter[11],
                         self.counter[12], self.counter[13], self.counter[14])

    def unpack_from(self, buffer, offset=0):
        (self._pack_0_32, self.counter[0], self.counter[1], self.counter[2], self.counter[3], self.counter[4],
         self.counter[5], self.counter[6], self.counter[7], self.counter[8], self.counter[9], self.counter[10],
         self.counter[11], self.counter[12], self.counter[13], self.counter[14],) = struct.unpack_from(
            '>LLLLLLLLLLLLLLLL', buffer, offset + 0)


class PMPortCounters(rdma.binstruct.BinStruct):
    """Port Basic Performance and Error Counters (section 16.1.3.5)"""
    __slots__ = (
    'reserved_0', 'portSelect', 'counterSelect', 'symbolErrorCounter', 'linkErrorRecoveryCounter', 'linkDownedCounter',
    'portRcvErrors', 'portRcvRemotePhysicalErrors', 'portRcvSwitchRelayErrors', 'portXmitDiscards',
    'portXmitConstraintErrors', 'portRcvConstraintErrors', 'counterSelect2', 'localLinkIntegrityErrors',
    'excessiveBufferOverrunErrors', 'reserved_160', 'VL15Dropped', 'portXmitData', 'portRcvData', 'portXmitPkts',
    'portRcvPkts', 'portXmitWait')
    MAD_LENGTH = 44
    MAD_ATTRIBUTE_ID = 0x12
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('symbolErrorCounter', 16, 1),
               ('linkErrorRecoveryCounter', 8, 1), ('linkDownedCounter', 8, 1), ('portRcvErrors', 16, 1),
               ('portRcvRemotePhysicalErrors', 16, 1), ('portRcvSwitchRelayErrors', 16, 1), ('portXmitDiscards', 16, 1),
               ('portXmitConstraintErrors', 8, 1), ('portRcvConstraintErrors', 8, 1), ('counterSelect2', 8, 1),
               ('localLinkIntegrityErrors', 4, 1), ('excessiveBufferOverrunErrors', 4, 1), ('reserved_160', 16, 1),
               ('VL15Dropped', 16, 1), ('portXmitData', 32, 1), ('portRcvData', 32, 1), ('portXmitPkts', 32, 1),
               ('portRcvPkts', 32, 1), ('portXmitWait', 32, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.portXmitConstraintErrors & 0xFF) << 24) | ((self.portRcvConstraintErrors & 0xFF) << 16) | (
                (self.counterSelect2 & 0xFF) << 8) | ((self.localLinkIntegrityErrors & 0xF) << 4) | (
                       (self.excessiveBufferOverrunErrors & 0xF) << 0)
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHBBHHHHLHHLLLLL', buffer, offset + 0, self.reserved_0, self.portSelect,
                         self.counterSelect, self.symbolErrorCounter, self.linkErrorRecoveryCounter,
                         self.linkDownedCounter, self.portRcvErrors, self.portRcvRemotePhysicalErrors,
                         self.portRcvSwitchRelayErrors, self.portXmitDiscards, self._pack_0_32, self.reserved_160,
                         self.VL15Dropped, self.portXmitData, self.portRcvData, self.portXmitPkts, self.portRcvPkts,
                         self.portXmitWait)

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.symbolErrorCounter, self.linkErrorRecoveryCounter,
         self.linkDownedCounter, self.portRcvErrors, self.portRcvRemotePhysicalErrors, self.portRcvSwitchRelayErrors,
         self.portXmitDiscards, self._pack_0_32, self.reserved_160, self.VL15Dropped, self.portXmitData,
         self.portRcvData, self.portXmitPkts, self.portRcvPkts, self.portXmitWait,) = struct.unpack_from(
            '>BBHHBBHHHHLHHLLLLL', buffer, offset + 0)


class PMPortRcvErrorDetails(rdma.binstruct.BinStruct):
    """Port Detailed Error Counters (section 16.1.4.1)"""
    __slots__ = ('reserved_0', 'portSelect', 'counterSelect', 'portLocalPhysicalErrors', 'portMalformedPacketErrors',
                 'portBufferOverrunErrors', 'portDLIDMappingErrors', 'portVLMappingErrors', 'portLoopingErrors')
    MAD_LENGTH = 16
    MAD_ATTRIBUTE_ID = 0x15
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('portLocalPhysicalErrors', 16, 1),
               ('portMalformedPacketErrors', 16, 1), ('portBufferOverrunErrors', 16, 1),
               ('portDLIDMappingErrors', 16, 1), ('portVLMappingErrors', 16, 1), ('portLoopingErrors', 16, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHHHHHH', buffer, offset + 0, self.reserved_0, self.portSelect, self.counterSelect,
                         self.portLocalPhysicalErrors, self.portMalformedPacketErrors, self.portBufferOverrunErrors,
                         self.portDLIDMappingErrors, self.portVLMappingErrors, self.portLoopingErrors)

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portLocalPhysicalErrors,
         self.portMalformedPacketErrors, self.portBufferOverrunErrors, self.portDLIDMappingErrors,
         self.portVLMappingErrors, self.portLoopingErrors,) = struct.unpack_from('>BBHHHHHHH', buffer, offset + 0)


class PMPortXmitDiscardDetails(rdma.binstruct.BinStruct):
    """Port Transmit Discard Counters (section 16.1.4.2)"""
    __slots__ = ('reserved_0', 'portSelect', 'counterSelect', 'portInactiveDiscards', 'portNeighborMTUDiscards',
                 'portSwLifetimeLimitDiscards', 'portSwHOQLimitDiscards')
    MAD_LENGTH = 12
    MAD_ATTRIBUTE_ID = 0x16
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('portInactiveDiscards', 16, 1),
               ('portNeighborMTUDiscards', 16, 1), ('portSwLifetimeLimitDiscards', 16, 1),
               ('portSwHOQLimitDiscards', 16, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHHHH', buffer, offset + 0, self.reserved_0, self.portSelect, self.counterSelect,
                         self.portInactiveDiscards, self.portNeighborMTUDiscards, self.portSwLifetimeLimitDiscards,
                         self.portSwHOQLimitDiscards)

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portInactiveDiscards, self.portNeighborMTUDiscards,
         self.portSwLifetimeLimitDiscards, self.portSwHOQLimitDiscards,) = struct.unpack_from('>BBHHHHH', buffer,
                                                                                              offset + 0)
...
class PMPortOpRcvCounters(rdma.binstruct.BinStruct):
    ...
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('opCode', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('portOpRcvPkts', 32, 1),
               ('portOpRcvData', 32, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLL', buffer, offset + 0, self.opCode, self.portSelect, self.counterSelect,
                         self.portOpRcvPkts, self.portOpRcvData)

    def unpack_from(self, buffer, offset=0):
        (
        self.opCode, self.portSelect, self.counterSelect, self.portOpRcvPkts, self.portOpRcvData,) = struct.unpack_from(
            '>BBHLL', buffer, offset + 0)
...
class PMPortFlowCtlCounters(rdma.binstruct.BinStruct):
    ...
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('portXmitFlowPkts', 32, 1),
               ('portRcvFlowPkts', 32, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLL', buffer, offset + 0, self.reserved_0, self.portSelect, self.counterSelect,
                         self.portXmitFlowPkts, self.portRcvFlowPkts)

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portXmitFlowPkts,
         self.portRcvFlowPkts,) = struct.unpack_from('>BBHLL', buffer, offset + 0)
...
class PMPortVLOpPackets(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.opCode, self.portSelect, self.counterSelect,
                         self.portVLOpPackets[0], self.portVLOpPackets[1], self.portVLOpPackets[2],
                         self.portVLOpPackets[3], self.portVLOpPackets[4], self.portVLOpPackets[5],
                         self.portVLOpPackets[6], self.portVLOpPackets[7], self.portVLOpPackets[8],
                         self.portVLOpPackets[9], self.portVLOpPackets[10], self.portVLOpPackets[11],
                         self.portVLOpPackets[12], self.portVLOpPackets[13], self.portVLOpPackets[14],
                         self.portVLOpPackets[15])

    def unpack_from(self, buffer, offset=0):
        (self.opCode, self.portSelect, self.counterSelect, self.portVLOpPackets[0], self.portVLOpPackets[1],
         self.portVLOpPackets[2], self.portVLOpPackets[3], self.portVLOpPackets[4], self.portVLOpPackets[5],
         self.portVLOpPackets[6], self.portVLOpPackets[7], self.portVLOpPackets[8], self.portVLOpPackets[9],
         self.portVLOpPackets[10], self.portVLOpPackets[11], self.portVLOpPackets[12], self.portVLOpPackets[13],
         self.portVLOpPackets[14], self.portVLOpPackets[15],) = struct.unpack_from('>BBHHHHHHHHHHHHHHHHH', buffer,
                                                                                   offset + 0)
...
class PMPortVLOpData(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLLLLLLLLLLLLLLLL', buffer, offset + 0, self.opCode, self.portSelect, self.counterSelect,
                         self.portVLOpData[0], self.portVLOpData[1], self.portVLOpData[2], self.portVLOpData[3],
                         self.portVLOpData[4], self.portVLOpData[5], self.portVLOpData[6], self.portVLOpData[7],
                         self.portVLOpData[8], self.portVLOpData[9], self.portVLOpData[10], self.portVLOpData[11],
                         self.portVLOpData[12], self.portVLOpData[13], self.portVLOpData[14], self.portVLOpData[15])

    def unpack_from(self, buffer, offset=0):
        (self.opCode, self.portSelect, self.counterSelect, self.portVLOpData[0], self.portVLOpData[1],
         self.portVLOpData[2], self.portVLOpData[3], self.portVLOpData[4], self.portVLOpData[5], self.portVLOpData[6],
         self.portVLOpData[7], self.portVLOpData[8], self.portVLOpData[9], self.portVLOpData[10], self.portVLOpData[11],
         self.portVLOpData[12], self.portVLOpData[13], self.portVLOpData[14],
         self.portVLOpData[15],) = struct.unpack_from('>BBHLLLLLLLLLLLLLLLL', buffer, offset + 0)
...
class PMPortVLXmitFlowCtlUpdateErrors(rdma.binstruct.BinStruct):
    ...
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1),
               ('portVLXmitFlowCtlUpdateErrors', 2, 16)]
...
class PMPortVLXmitWaitCounters(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.reserved_0, self.portSelect,
                         self.counterSelect, self.portVLXmitWait[0], self.portVLXmitWait[1], self.portVLXmitWait[2],
                         self.portVLXmitWait[3], self.portVLXmitWait[4], self.portVLXmitWait[5], self.portVLXmitWait[6],
                         self.portVLXmitWait[7], self.portVLXmitWait[8], self.portVLXmitWait[9],
                         self.portVLXmitWait[10], self.portVLXmitWait[11], self.portVLXmitWait[12],
                         self.portVLXmitWait[13], self.portVLXmitWait[14], self.portVLXmitWait[15])

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portVLXmitWait[0], self.portVLXmitWait[1],
         self.portVLXmitWait[2], self.portVLXmitWait[3], self.portVLXmitWait[4], self.portVLXmitWait[5],
         self.portVLXmitWait[6], self.portVLXmitWait[7], self.portVLXmitWait[8], self.portVLXmitWait[9],
         self.portVLXmitWait[10], self.portVLXmitWait[11], self.portVLXmitWait[12], self.portVLXmitWait[13],
         self.portVLXmitWait[14], self.portVLXmitWait[15],) = struct.unpack_from('>BBHHHHHHHHHHHHHHHHH', buffer,
                                                                                 offset + 0)
...
class PMSwPortVLCongestion(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHHHHHHHHHHHHHHHHH', buffer, offset + 0, self.reserved_0, self.portSelect,
                         self.counterSelect, self.swPortVLCongestion[0], self.swPortVLCongestion[1],
                         self.swPortVLCongestion[2], self.swPortVLCongestion[3], self.swPortVLCongestion[4],
                         self.swPortVLCongestion[5], self.swPortVLCongestion[6], self.swPortVLCongestion[7],
                         self.swPortVLCongestion[8], self.swPortVLCongestion[9], self.swPortVLCongestion[10],
                         self.swPortVLCongestion[11], self.swPortVLCongestion[12], self.swPortVLCongestion[13],
                         self.swPortVLCongestion[14], self.swPortVLCongestion[15])

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.swPortVLCongestion[0], self.swPortVLCongestion[1],
         self.swPortVLCongestion[2], self.swPortVLCongestion[3], self.swPortVLCongestion[4], self.swPortVLCongestion[5],
         self.swPortVLCongestion[6], self.swPortVLCongestion[7], self.swPortVLCongestion[8], self.swPortVLCongestion[9],
         self.swPortVLCongestion[10], self.swPortVLCongestion[11], self.swPortVLCongestion[12],
         self.swPortVLCongestion[13], self.swPortVLCongestion[14], self.swPortVLCongestion[15],) = struct.unpack_from(
            '>BBHHHHHHHHHHHHHHHHH', buffer, offset + 0)
...
class PMPortSamplesResExt(rdma.binstruct.BinStruct):
    ...
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('tag', 16, 1), ('reserved_16', 14, 1), ('sampleStatus', 2, 1), ('extendedWidth', 2, 1),
               ('reserved_34', 30, 1), ('counter', 64, 15)]
...
class PMPortCountersExt(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'reserved_0', 'portSelect', 'counterSelect', 'reserved_32', 'portXmitData', 'portRcvData', 'portXmitPkts',
    'portRcvPkts', 'portUnicastXmitPkts', 'portUnicastRcvPkts', 'portMulticastXmitPkts', 'portMulticastRcvPkts')
    MAD_LENGTH = 72
    MAD_ATTRIBUTE_ID = 0x1d
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    MAD_PERFORMANCESET = 0x2  # MAD_METHOD_SET
    MEMBERS = [('reserved_0', 8, 1), ('portSelect', 8, 1), ('counterSelect', 16, 1), ('reserved_32', 32, 1),
               ('portXmitData', 64, 1), ('portRcvData', 64, 1), ('portXmitPkts', 64, 1), ('portRcvPkts', 64, 1),
               ('portUnicastXmitPkts', 64, 1), ('portUnicastRcvPkts', 64, 1), ('portMulticastXmitPkts', 64, 1),
               ('portMulticastRcvPkts', 64, 1)]
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLQQQQQQQQ', buffer, offset + 0, self.reserved_0, self.portSelect, self.counterSelect,
                         self.reserved_32, self.portXmitData, self.portRcvData, self.portXmitPkts, self.portRcvPkts,
                         self.portUnicastXmitPkts, self.portUnicastRcvPkts, self.portMulticastXmitPkts,
                         self.portMulticastRcvPkts)

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.reserved_32, self.portXmitData, self.portRcvData,
         self.portXmitPkts, self.portRcvPkts, self.portUnicastXmitPkts, self.portUnicastRcvPkts,
         self.portMulticastXmitPkts, self.portMulticastRcvPkts,) = struct.unpack_from('>BBHLQQQQQQQQ', buffer,
                                                                                      offset + 0)
...
class PMPortXmitDataSL(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLLLLLLLLLLLLLLLL', buffer, offset + 0, self.reserved_0, self.portSelect,
                         self.counterSelect, self.portXmitDataSL[0], self.portXmitDataSL[1], self.portXmitDataSL[2],
                         self.portXmitDataSL[3], self.portXmitDataSL[4], self.portXmitDataSL[5], self.portXmitDataSL[6],
                         self.portXmitDataSL[7], self.portXmitDataSL[8], self.portXmitDataSL[9],
                         self.portXmitDataSL[10], self.portXmitDataSL[11], self.portXmitDataSL[12],
                         self.portXmitDataSL[13], self.portXmitDataSL[14], self.portXmitDataSL[15])

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portXmitDataSL[0], self.portXmitDataSL[1],
         self.portXmitDataSL[2], self.portXmitDataSL[3], self.portXmitDataSL[4], self.portXmitDataSL[5],
         self.portXmitDataSL[6], self.portXmitDataSL[7], self.portXmitDataSL[8], self.portXmitDataSL[9],
         self.portXmitDataSL[10], self.portXmitDataSL[11], self.portXmitDataSL[12], self.portXmitDataSL[13],
         self.portXmitDataSL[14], self.portXmitDataSL[15],) = struct.unpack_from('>BBHLLLLLLLLLLLLLLLL', buffer,
                                                                                 offset + 0)
...
class PMPortRcvDataSL(rdma.binstruct.BinStruct):
    ...
    def pack_into(self, buffer, offset=0):
        struct.pack_into('>BBHLLLLLLLLLLLLLLLL', buffer, offset + 0, self.reserved_0, self.portSelect,
                         self.counterSelect, self.portRcvDataSL[0], self.portRcvDataSL[1], self.portRcvDataSL[2],
                         self.portRcvDataSL[3], self.portRcvDataSL[4], self.portRcvDataSL[5], self.portRcvDataSL[6],
                         self.portRcvDataSL[7], self.portRcvDataSL[8], self.portRcvDataSL[9], self.portRcvDataSL[10],
                         self.portRcvDataSL[11], self.portRcvDataSL[12], self.portRcvDataSL[13], self.portRcvDataSL[14],
                         self.portRcvDataSL[15])

    def unpack_from(self, buffer, offset=0):
        (self.reserved_0, self.portSelect, self.counterSelect, self.portRcvDataSL[0], self.portRcvDataSL[1],
         self.portRcvDataSL[2], self.portRcvDataSL[3], self.portRcvDataSL[4], self.portRcvDataSL[5],
         self.portRcvDataSL[6], self.portRcvDataSL[7], self.portRcvDataSL[8], self.portRcvDataSL[9],
         self.portRcvDataSL[10], self.portRcvDataSL[11], self.portRcvDataSL[12], self.portRcvDataSL[13],
         self.portRcvDataSL[14], self.portRcvDataSL[15],) = struct.unpack_from('>BBHLLLLLLLLLLLLLLLL', buffer,
                                                                               offset + 0)
...
class DMIOUnitInfo(rdma.binstruct.BinStruct):
    ...
    MAD_ATTRIBUTE_ID = 0x10
    MAD_DEVMGTGET = 0x1  # MAD_METHOD_GET
    MEMBERS = [('changeID', 16, 1), ('maxControllers', 8, 1), ('reserved_24', 6, 1), ('diagDeviceID', 1, 1),
               ('optionROM', 1, 1), ('controllerList', 1024, 1)]
    ...
    @property
    def _pack_0_32(self):
        return ((self.changeID & 0xFFFF) << 16) | ((self.maxControllers & 0xFF) << 8) | (
                (self.reserved_24 & 0x3F) << 2) | ((self.diagDeviceID & 0x1) << 1) | ((self.optionROM & 0x1) << 0)
...
class DMIOControllerProfile(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
    'GUID', 'vendorID', 'reserved_88', 'deviceID', 'deviceVersion', 'reserved_144', 'subsystemVendorID', 'reserved_184',
    'subsystemID', 'IOClass', 'IOSubclass', 'protocol', 'protocolVersion', 'reserved_288', 'reserved_304',
    'sendMessageDepth', 'reserved_336', 'RDMAReadDepth', 'sendMessageSize', 'RDMATransferSize',
    'controllerOperationsMask', 'reserved_424', 'serviceEntries', 'reserved_440', 'reserved_448', 'IDString')
    MAD_LENGTH = 128
    MAD_ATTRIBUTE_ID = 0x11
    MAD_DEVMGTGET = 0x1  # MAD_METHOD_GET
    MEMBERS = [('GUID', 64, 1), ('vendorID', 24, 1), ('reserved_88', 8, 1), ('deviceID', 32, 1),
               ('deviceVersion', 16, 1), ('reserved_144', 16, 1), ('subsystemVendorID', 24, 1), ('reserved_184', 8, 1),
               ('subsystemID', 32, 1), ('IOClass', 16, 1), ('IOSubclass', 16, 1), ('protocol', 16, 1),
               ('protocolVersion', 16, 1), ('reserved_288', 16, 1), ('reserved_304', 16, 1),
               ('sendMessageDepth', 16, 1), ('reserved_336', 8, 1), ('RDMAReadDepth', 8, 1), ('sendMessageSize', 32, 1),
               ('RDMATransferSize', 32, 1), ('controllerOperationsMask', 8, 1), ('reserved_424', 8, 1),
               ('serviceEntries', 8, 1), ('reserved_440', 8, 1), ('reserved_448', 64, 1), ('IDString', 8, 64)]
    ...
    def pack_into(self, buffer, offset=0):
        ...
        struct.pack_into('>LLHHLLHHHHHHHBBLLBBBBQ', buffer, offset + 8, self._pack_0_32, self.deviceID,
                         self.deviceVersion, self.reserved_144, self._pack_1_32, self.subsystemID, self.IOClass,
                         self.IOSubclass, self.protocol, self.protocolVersion, self.reserved_288, self.reserved_304,
                         self.sendMessageDepth, self.reserved_336, self.RDMAReadDepth, self.sendMessageSize,
                         self.RDMATransferSize, self.controllerOperationsMask, self.reserved_424, self.serviceEntries,
                         self.reserved_440, self.reserved_448)

    def unpack_from(self, buffer, offset=0):
        self.GUID = IBA.GUID(buffer[offset + 0:offset + 8], raw=True)
        self.IDString = bytearray(buffer[offset + 64:offset + 128])
        (self._pack_0_32, self.deviceID, self.deviceVersion, self.reserved_144, self._pack_1_32, self.subsystemID,
         self.IOClass, self.IOSubclass, self.protocol, self.protocolVersion, self.reserved_288, self.reserved_304,
         self.sendMessageDepth, self.reserved_336, self.RDMAReadDepth, self.sendMessageSize, self.RDMATransferSize,
         self.controllerOperationsMask, self.reserved_424, self.serviceEntries, self.reserved_440,
         self.reserved_448,) = struct.unpack_from('>LLHHLLHHHHHHHBBLLBBBBQ', buffer, offset + 8)
...
MEMBER_FORMATS = {
    'counterSelect2': 'hex', 'counterSelect3': 'hex', 'counterSelect0': 'hex', 'counterSelect1': 'hex',
    'counterSelect6': 'hex', 'nodeString': 'str', 'counterSelect4': 'hex', 'redirectPKey': 'hex', 'diagCode': 'hex',
    'servicePKey': 'hex', 'QOSClass': 'hex', 'initType': 'hex', 'trapQP': 'hex', 'counterSelect10': 'hex',
    'altTClass': 'hex', 'MLID': 'hex', 'counterSelect': 'hex', 'QKey': 'hex', 'counterSelect12': 'hex',
    'counterSelect7': 'hex', 'vendorID': 'hex', 'capabilityMask': 'hex', 'initTypeReply': 'hex',
    'counterSelect14': 'hex', 'redirectQKey': 'hex', 'counterSelect5': 'hex', 'serviceName': 'str', 'IDString': 'str',
    'PKeyBlock': 'hex', 'communityName': 'str', 'counterSelect8': 'hex', 'revision': 'hex', 'PKey': 'hex',
