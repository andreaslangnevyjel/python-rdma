...
class HdrBTH(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "service", "function", "SE", "migReq", "padCnt", "TVer", "PKey", "reserved_32", "destQP", "ackReq", "reserved_65", "PSN",
    )
    MAD_LENGTH = 12
    MEMBERS = [
        ("service", 3, 1),
...
class CMFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "data",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x7
...
class CMPath(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "SLID", "DLID", "SGID", "DGID", "flowLabel", "reserved_308", "reserved_312", "PD", "TClass", "hopLimit", "SL", "subnetLocal", "reserved_341", "localACKTimeout", "reserved_349",
    )
    MAD_LENGTH = 44
    MEMBERS = [
        ("SLID", 16, 1),
...
class CMREQ(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "reserved_32", "serviceID", "LGUID", "localCMQKey", "localQKey", "localQPN", "responderResources", "localEECN", "initiatorDepth", "remoteEECN", "remoteResponseTimeout", "transportService", "flowControl", "startingPSN", "localResponseTimeout", "retryCount", "PKey", "pathPacketMTU", "RDCExists", "RNRRetryCount", "maxCMRetries", "reserved_412", "primaryPath", "alternatePath", "privateData",
    )
    MAD_LENGTH = 232
    ...
    MEMBERS = [
        ...
        ("localQKey", 32, 1),
        ("localQPN", 24, 1),
        ("responderResources", 8, 1),
        ("localEECN", 24, 1),
        ("initiatorDepth", 8, 1),
        ("remoteEECN", 24, 1),
        ("remoteResponseTimeout", 5, 1),
        ("transportService", 2, 1),
        ("flowControl", 1, 1),
        ("startingPSN", 24, 1),
        ("localResponseTimeout", 5, 1),
        ("retryCount", 3, 1),
        ("PKey", 16, 1),
        ("pathPacketMTU", 4, 1),
        ("RDCExists", 1, 1),
...
class CMREJ(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "RCID", "messageRejected", "reserved_66", "rejectInfoLength", "reserved_79", "reason", "ARI", "privateData",
    )
    MAD_LENGTH = 232
...
class CMREP(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "RCID", "localQKey", "localQPN", "reserved_120", "localEEContext", "reserved_152", "startingPSN", "reserved_184", "responderResources", "initiatorDepth", "targetACKDelay", "failoverAccepted", "flowControl", "RNRRetryCount", "reserved_219", "LGUID", "privateData",
    )
    MAD_LENGTH = 232
...
class CMDREQ(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "RCID", "remoteQPN", "reserved_88", "privateData",
    )
    MAD_LENGTH = 232
...
class CMLAP(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "RCID", "QKey", "RQPN", "RCMTimeout", "reserved_125", "reserved_128", "altSLID", "altDLID", "altSGID", "altDGID", "altFlowLabel", "reserved_468", "altTClass", "altHopLimit", "reserved_488", "altIPD", "altSL", "altSubnetLocal", "reserved_501", "altLocalACKTimeout", "reserved_509", "privateData",
    )
    MAD_LENGTH = 232
...
class CMAPR(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LCID", "RCID", "additionalInfoLength", "APstatus", "reserved_80", "additionalInfo", "privateData",
    )
    MAD_LENGTH = 232
    ...
    MEMBERS = [
        ("LCID", 32, 1),
        ("RCID", 32, 1),
        ("additionalInfoLength", 8, 1),
        ("APstatus", 8, 1),
        ("reserved_80", 16, 1),
        ("additionalInfo", 576, 1),
        ("privateData", 1184, 1),
    ]
...
class CMSIDR_REQ(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "requestID", "reserved_32", "serviceID", "privateData",
    )
    MAD_LENGTH = 232
...
class CMSIDR_REP(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "requestID", "QPN", "status", "serviceID", "QKey", "classPortinfo", "privateData",
    )
    MAD_LENGTH = 232
...
class MADHeader(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier",
    )
    MAD_LENGTH = 24
    MEMBERS = [
        ("baseVersion", 8, 1),
...
class MADHeaderDirected(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "D", "status", "hopPointer", "hopCount", "transactionID", "attributeID", "reserved_144", "attributeModifier",
    )
    MAD_LENGTH = 24
    MEMBERS = [
        ("baseVersion", 8, 1),
...
class MADClassPortInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "baseVersion", "classVersion", "capabilityMask", "capabilityMask2", "respTimeValue", "redirectGID", "redirectTC", "redirectSL", "redirectFL", "redirectLID", "redirectPKey", "reserved_256", "redirectQP", "redirectQKey", "trapGID", "trapTC", "trapSL", "trapFL", "trapLID", "trapPKey", "trapHL", "trapQP", "trapQKey",
    )
    MAD_LENGTH = 72
...
class MADInformInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "GID", "LIDRangeBegin", "LIDRangeEnd", "reserved_160", "isGeneric", "subscribe", "type", "trapNumber", "QPN", "reserved_248", "respTimeValue", "reserved_256", "producerType",
    )
    MAD_LENGTH = 36
...
class RMPPHeader(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "MADHeader", "RMPPVersion", "RMPPType", "RRespTime", "RMPPFlags", "RMPPStatus", "data1", "data2",
    )
    MAD_LENGTH = 36
    MEMBERS = [
        ("MADHeader", 192, 1),
...
class RMPPShortHeader(rdma.binstruct.BinStruct):
    """RMPP Header Fields (section 13.6.2.1)"""
    __slots__ = (
        "MADHeader", "RMPPVersion", "RMPPType", "RRespTime", "RMPPFlags", "RMPPStatus",
    )
    MAD_LENGTH = 28
    MEMBERS = [
        ("MADHeader", 192, 1),
...
class RMPPData(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "RMPPHeader", "segmentNumber", "payLoadLength", "data",
    )
    MAD_LENGTH = 256
    MEMBERS = [
        ("RMPPHeader", 224, 1),
...
class RMPPAck(rdma.binstruct.BinStruct):
    """RMPP Data Packet (section 13.6.2.3)"""
    __slots__ = (
        "RMPPHeader", "segmentNumber", "newWindowLast", "reserved_288",
    )
    MAD_LENGTH = 256
    MEMBERS = [
        ("RMPPHeader", 224, 1),
...
class RMPPAbort(rdma.binstruct.BinStruct):
    """RMPP Data Packet (section 13.6.2.3)"""
    __slots__ = (
        "RMPPHeader", "reserved_224", "reserved_256", "errorData",
    )
    MAD_LENGTH = 256
    MEMBERS = [
        ("RMPPHeader", 224, 1),
...
class SMPLIDPortBlock(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "valid", "LMC", "reserved_20", "port",
    )
    MAD_LENGTH = 4
    MEMBERS = [
        ("LID", 16, 1),
...
class SMPFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "MKey", "reserved_256", "data", "reserved_1024",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x1
...
class SMPFormatDirected(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "D", "status", "hopPointer", "hopCount", "transactionID", "attributeID", "reserved_144", "attributeModifier", "MKey", "drSLID", "drDLID", "reserved_288", "data", "initialPath", "returnPath",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x81
    MAD_CLASS_VERSION = 0x1
...
class SMPNodeInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "baseVersion", "classVersion", "nodeType", "numPorts", "systemImageGUID", "nodeGUID", "portGUID", "partitionCap", "deviceID", "revision", "localPortNum", "vendorID",
    )
    MAD_LENGTH = 40
    MAD_ATTRIBUTE_ID = 0x11
    MAD_SUBNGET = 0x1  # MAD_METHOD_GET
...
class SMPSwitchInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "linearFDBCap", "randomFDBCap", "multicastFDBCap", "linearFDBTop", "defaultPort", "defaultMulticastPrimaryPort", "defaultMulticastNotPrimaryPort", "lifeTimeValue", "portStateChange", "optimizedSLtoVLMappingProgramming", "LIDsPerPort", "partitionEnforcementCap", "inboundEnforcementCap", "outboundEnforcementCap", "filterRawInboundCap", "filterRawOutboundCap", "enhancedPort0", "reserved_133", "reserved_136", "multicastFDBTop",
    )
    MAD_LENGTH = 20
    MAD_ATTRIBUTE_ID = 0x12
    MAD_SUBNGET = 0x1  # MAD_METHOD_GET
    ...
    MEMBERS = [
        ("linearFDBCap", 16, 1),
        ("randomFDBCap", 16, 1),
        ("multicastFDBCap", 16, 1),
        ("linearFDBTop", 16, 1),
        ("defaultPort", 8, 1),
        ("defaultMulticastPrimaryPort", 8, 1),
        ("defaultMulticastNotPrimaryPort", 8, 1),
        ("lifeTimeValue", 5, 1),
        ("portStateChange", 1, 1),
        ("optimizedSLtoVLMappingProgramming", 2, 1),
        ("LIDsPerPort", 16, 1),
        ("partitionEnforcementCap", 16, 1),
        ("inboundEnforcementCap", 1, 1),
        ("outboundEnforcementCap", 1, 1),
        ("filterRawInboundCap", 1, 1),
        ("filterRawOutboundCap", 1, 1),
        ("enhancedPort0", 1, 1),
        ("reserved_133", 3, 1),
        ("reserved_136", 8, 1),
        ("multicastFDBTop", 16, 1),
    ]
...
class SMPGUIDInfo(rdma.binstruct.BinStruct):
    ...
    def __init__(self, *args):
        self.GUIDBlock = [IBA.GUID() for _idx in range(8)]
        rdma.binstruct.BinStruct.__init__(self, *args)
...
class SMPPortInfo(rdma.binstruct.BinStruct):
    ...
    MEMBERS = [
        ...
        ("capabilityMask", 32, 1),
        ("diagCode", 16, 1),
        ("MKeyLeasePeriod", 16, 1),
        ("localPortNum", 8, 1),
        ("linkWidthEnabled", 8, 1),
        ("linkWidthSupported", 8, 1),
        ("linkWidthActive", 8, 1),
        ("linkSpeedSupported", 4, 1),
        ("portState", 4, 1),
        ("portPhysicalState", 4, 1),
        ("linkDownDefaultState", 4, 1),
        ("MKeyProtectBits", 2, 1),
        ("reserved_274", 3, 1),
        ("LMC", 3, 1),
        ("linkSpeedActive", 4, 1),
        ("linkSpeedEnabled", 4, 1),
        ("neighborMTU", 4, 1),
        ("masterSMSL", 4, 1),
        ("VLCap", 4, 1),
        ("initType", 4, 1),
        ("VLHighLimit", 8, 1),
        ("VLArbitrationHighCap", 8, 1),
        ("VLArbitrationLowCap", 8, 1),
        ("initTypeReply", 4, 1),
        ("MTUCap", 4, 1),
        ("VLStallCount", 3, 1),
        ("HOQLife", 5, 1),
        ("operationalVLs", 4, 1),
        ("partitionEnforcementInbound", 1, 1),
        ("partitionEnforcementOutbound", 1, 1),
        ("filterRawInbound", 1, 1),
        ("filterRawOutbound", 1, 1),
        ("MKeyViolations", 16, 1),
        ("PKeyViolations", 16, 1),
        ("QKeyViolations", 16, 1),
        ("GUIDCap", 8, 1),
        ("clientReregister", 1, 1),
        ("multicastPKeyTrapSuppressionEnabled", 2, 1),
        ("subnetTimeOut", 5, 1),
        ("reserved_416", 3, 1),
        ("respTimeValue", 5, 1),
        ("localPhyErrors", 4, 1),
        ...
        ("maxCreditHint", 16, 1),
        ("reserved_448", 8, 1),
        ("linkRoundTripLatency", 24, 1),
        ("capabilityMask2", 16, 1),
        ("linkSpeedExtActive", 4, 1),
        ("linkSpeedExtSupported", 4, 1),
        ("reserved_504", 3, 1),
...
class SMPRandomForwardingTable(rdma.binstruct.BinStruct):
    ...
    def __init__(self, *args):
        self.LIDPortBlock = [SMPLIDPortBlock() for _idx in range(16)]
        rdma.binstruct.BinStruct.__init__(self, *args)
...
class SMPSMInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "GUID", "SMKey", "actCount", "priority", "SMState", "reserved_168",
    )
    MAD_LENGTH = 24
...
class SMPVendorDiag(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "nextIndex", "reserved_16", "diagData",
    )
    MAD_LENGTH = 64
...
class SMPNoticeTrap(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "isGeneric", "noticeType", "nodeType", "trapNumber", "issuerLID", "noticeToggle", "noticeCount", "dataDetails", "dataDetails2",
    )
    MAD_LENGTH = 64
...
class SAHeader(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "RMPPVersion", "RMPPType", "RRespTime", "RMPPFlags", "RMPPStatus", "data1", "data2", "SMKey", "attributeOffset", "reserved_368", "componentMask",
    )
    MAD_LENGTH = 56
    MAD_CLASS = 0x3
    MAD_CLASS_VERSION = 0x2
...
class SAFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "RMPPVersion", "RMPPType", "RRespTime", "RMPPFlags", "RMPPStatus", "data1", "data2", "SMKey", "attributeOffset", "reserved_368", "componentMask", "data",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x3
    MAD_CLASS_VERSION = 0x2
...
class SANodeRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "reserved_16", "nodeInfo", "nodeDescription",
    )
    MAD_LENGTH = 108
    MAD_ATTRIBUTE_ID = 0x11
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
    ...
    COMPONENT_MASK = {
        "LID": 0,
        "reserved_16": 1,
        "nodeInfo.baseVersion": 2,
        "nodeInfo.classVersion": 3,
        "nodeInfo.nodeType": 4,
        "nodeInfo.numPorts": 5,
        "nodeInfo.systemImageGUID": 6,
        "nodeInfo.nodeGUID": 7,
        "nodeInfo.portGUID": 8,
        "nodeInfo.partitionCap": 9,
        "nodeInfo.deviceID": 10,
        "nodeInfo.revision": 11,
        "nodeInfo.localPortNum": 12,
        "nodeInfo.vendorID": 13,
        "nodeDescription.nodeString": 14,
    }
    MEMBERS = [
        ("LID", 16, 1),
        ("reserved_16", 16, 1),
        ("nodeInfo", 320, 1),
        ("nodeDescription", 512, 1),
    ]
...
class SAPortInfoRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "endportLID", "portNum", "reserved_24", "portInfo",
    )
    MAD_LENGTH = 68
    MAD_ATTRIBUTE_ID = 0x12
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
    ...
    COMPONENT_MASK = {
        ...
        "reserved_24": 2,
        "portInfo.MKey": 3,
        "portInfo.GIDPrefix": 4,
        "portInfo.LID": 5,
        "portInfo.masterSMLID": 6,
        "portInfo.capabilityMask": 7,
        "portInfo.diagCode": 8,
        "portInfo.MKeyLeasePeriod": 9,
        "portInfo.localPortNum": 10,
        "portInfo.linkWidthEnabled": 11,
        "portInfo.linkWidthSupported": 12,
        "portInfo.linkWidthActive": 13,
        "portInfo.linkSpeedSupported": 14,
        "portInfo.portState": 15,
        "portInfo.portPhysicalState": 16,
        "portInfo.linkDownDefaultState": 17,
        "portInfo.MKeyProtectBits": 18,
        "portInfo.reserved_274": 19,
        "portInfo.LMC": 20,
        "portInfo.linkSpeedActive": 21,
        "portInfo.linkSpeedEnabled": 22,
        "portInfo.neighborMTU": 23,
        "portInfo.masterSMSL": 24,
        "portInfo.VLCap": 25,
        "portInfo.initType": 26,
        "portInfo.VLHighLimit": 27,
        "portInfo.VLArbitrationHighCap": 28,
        "portInfo.VLArbitrationLowCap": 29,
        "portInfo.initTypeReply": 30,
        "portInfo.MTUCap": 31,
        "portInfo.VLStallCount": 32,
        "portInfo.HOQLife": 33,
        "portInfo.operationalVLs": 34,
        "portInfo.partitionEnforcementInbound": 35,
        "portInfo.partitionEnforcementOutbound": 36,
        "portInfo.filterRawInbound": 37,
        "portInfo.filterRawOutbound": 38,
        "portInfo.MKeyViolations": 39,
        "portInfo.PKeyViolations": 40,
        "portInfo.QKeyViolations": 41,
        "portInfo.GUIDCap": 42,
        "portInfo.clientReregister": 43,
        "portInfo.multicastPKeyTrapSuppressionEnabled": 44,
        "portInfo.subnetTimeOut": 45,
        "portInfo.reserved_416": 46,
        "portInfo.respTimeValue": 47,
        "portInfo.localPhyErrors": 48,
        "portInfo.overrunErrors": 49,
        "portInfo.maxCreditHint": 50,
        "portInfo.reserved_448": 51,
        "portInfo.linkRoundTripLatency": 52,
        "portInfo.capabilityMask2": 53,
        "portInfo.linkSpeedExtActive": 54,
        "portInfo.linkSpeedExtSupported": 55,
        "portInfo.reserved_504": 56,
...
class SASLToVLMappingTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "inputPortNum", "outputPortNum", "reserved_32", "SLToVLMappingTable",
    )
    MAD_LENGTH = 16
    MAD_ATTRIBUTE_ID = 0x13
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
...
class SASwitchInfoRecord(rdma.binstruct.BinStruct):
    ...
    COMPONENT_MASK = {
        "LID": 0,
        "reserved_16": 1,
        "switchInfo.linearFDBCap": 2,
        "switchInfo.randomFDBCap": 3,
        "switchInfo.multicastFDBCap": 4,
        "switchInfo.linearFDBTop": 5,
        "switchInfo.defaultPort": 6,
        "switchInfo.defaultMulticastPrimaryPort": 7,
        "switchInfo.defaultMulticastNotPrimaryPort": 8,
        "switchInfo.lifeTimeValue": 9,
        "switchInfo.portStateChange": 10,
        "switchInfo.optimizedSLtoVLMappingProgramming": 11,
        "switchInfo.LIDsPerPort": 12,
        "switchInfo.partitionEnforcementCap": 13,
        "switchInfo.inboundEnforcementCap": 14,
        "switchInfo.outboundEnforcementCap": 15,
        "switchInfo.filterRawInboundCap": 16,
        "switchInfo.filterRawOutboundCap": 17,
        "switchInfo.enhancedPort0": 18,
        "switchInfo.reserved_133": 19,
        "switchInfo.reserved_136": 20,
        "switchInfo.multicastFDBTop": 21,
    }
    MEMBERS = [
        ("LID", 16, 1),
        ("reserved_16", 16, 1),
...
class SALinearForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "blockNum", "reserved_32", "linearForwardingTable",
    )
    MAD_LENGTH = 72
    MAD_ATTRIBUTE_ID = 0x15
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
    ...
    COMPONENT_MASK = {
        ...
        "blockNum": 1,
        "reserved_32": 2,
        "linearForwardingTable.portBlock": 3,
    }
    MEMBERS = [
        ("LID", 16, 1),
        ("blockNum", 16, 1),
        ("reserved_32", 32, 1),
        ("linearForwardingTable", 512, 1),
    ]
...
class SARandomForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "blockNum", "reserved_32", "randomForwardingTable",
    )
    MAD_LENGTH = 72
    MAD_ATTRIBUTE_ID = 0x16
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
    ...
    COMPONENT_MASK = {
        ...
        "blockNum": 1,
        "reserved_32": 2,
        "randomForwardingTable.LIDPortBlock": 3,
    }
    MEMBERS = [
        ("LID", 16, 1),
        ("blockNum", 16, 1),
        ("reserved_32", 32, 1),
        ("randomForwardingTable", 512, 1),
    ]
...
class SAMulticastForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "reserved_16", "position", "blockNum", "reserved_32", "multicastForwardingTable",
    )
    MAD_LENGTH = 72
    MAD_ATTRIBUTE_ID = 0x17
    MAD_SUBNADMGET = 0x1  # MAD_METHOD_GET
...
class SAVLArbitrationTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "outputPortNum", "blockNum", "reserved_32", "VLArbitrationTable",
    )
    MAD_LENGTH = 72
    ...
    COMPONENT_MASK = {
        ...
        "blockNum": 2,
        "reserved_32": 3,
        "VLArbitrationTable.VLWeightBlock": 4,
    }
    MEMBERS = [
        ("LID", 16, 1),
        ("outputPortNum", 8, 1),
...
class SAInformInfoRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "subscriberGID", "enumeration", "reserved_144", "reserved_160", "informInfo", "reserved_480",
    )
    MAD_LENGTH = 80
    ...
    COMPONENT_MASK = {
        ...
        "reserved_144": 2,
        "informInfo.GID": 3,
        "informInfo.LIDRangeBegin": 4,
        "informInfo.LIDRangeEnd": 5,
        "informInfo.reserved_160": 6,
        "informInfo.isGeneric": 7,
        "informInfo.subscribe": 8,
        "informInfo.type": 9,
        "informInfo.trapNumber": 10,
        "informInfo.QPN": 11,
        "informInfo.reserved_248": 12,
        "informInfo.respTimeValue": 13,
        "informInfo.reserved_256": 14,
        "informInfo.producerType": 15,
        "reserved_480": 16,
    }
    MEMBERS = [
        ("subscriberGID", 128, 1),
...
class SAGUIDInfoRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "blockNum", "reserved_24", "reserved_32", "GUIDInfo",
    )
    MAD_LENGTH = 72
    MAD_ATTRIBUTE_ID = 0x30
...
class SAServiceRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "serviceID", "serviceGID", "servicePKey", "reserved_208", "serviceLease", "serviceKey", "serviceName", "serviceData8", "serviceData16", "serviceData32", "serviceData64",
    )
    MAD_LENGTH = 176
    MAD_ATTRIBUTE_ID = 0x31
    MAD_SUBNADMDELETE = 0x15  # MAD_METHOD_DELETE
...
class SAPKeyTableRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "LID", "blockNum", "portNum", "reserved_40", "PKeyTable",
    )
    MAD_LENGTH = 72
...
class SAPathRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "serviceID", "DGID", "SGID", "DLID", "SLID", "rawTraffic", "reserved_353", "flowLabel", "hopLimit", "TClass", "reversible", "numbPath", "PKey", "QOSClass", "SL", "MTUSelector", "MTU", "rateSelector", "rate", "packetLifeTimeSelector", "packetLifeTime", "preference", "reversePathPKeyMemberBit", "reserved_466", "reserved_480",
    )
    MAD_LENGTH = 64
    ...
    COMPONENT_MASK = {
        ...
        "rateSelector": 18,
        "rate": 19,
        "packetLifeTimeSelector": 20,
        "packetLifeTime": 21,
        "preference": 22,
        "reversePathPKeyMemberBit": 23,
        "reserved_466": 24,
        "reserved_480": 25,
    }
    MEMBERS = [
        ...
        ("rateSelector", 2, 1),
        ("rate", 6, 1),
        ("packetLifeTimeSelector", 2, 1),
        ("packetLifeTime", 6, 1),
        ("preference", 8, 1),
        ("reversePathPKeyMemberBit", 2, 1),
        ("reserved_466", 14, 1),
        ("reserved_480", 32, 1),
    ]
...
class SAMCMemberRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "MGID", "portGID", "QKey", "MLID", "MTUSelector", "MTU", "TClass", "PKey", "rateSelector", "rate", "packetLifeTimeSelector", "packetLifeTime", "SL", "flowLabel", "hopLimit", "scope", "joinState", "proxyJoin", "reserved_393",
    )
    MAD_LENGTH = 52
...
class SATraceRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "GIDPrefix", "IDGeneration", "reserved_80", "nodeType", "nodeID", "chassisID", "entryPortID", "exitPortID", "entryPort", "exitPort", "reserved_368",
    )
    MAD_LENGTH = 48
...
class SAMultiPathRecord(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "rawTraffic", "reserved_1", "flowLabel", "hopLimit", "TClass", "reversible", "numbPath", "PKey", "reserved_64", "SL", "MTUSelector", "MTU", "rateSelector", "rate", "packetLifeTimeSelector", "packetLifeTime", "reserved_104", "independenceSelector", "reserved_114", "SGIDCount", "DGIDCount", "reserved_136", "reserved_160", "SDGID",
    )
    MAD_LENGTH = 40
    ...
    COMPONENT_MASK = {
        ...
        "rateSelector": 12,
        "rate": 13,
        "packetLifeTimeSelector": 14,
        "packetLifeTime": 15,
        "reserved_104": 16,
        "independenceSelector": 17,
        "reserved_114": 18,
        "SGIDCount": 19,
        "DGIDCount": 20,
        "reserved_136": 21,
...
class PMFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "reserved_192", "data",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x4
    MAD_CLASS_VERSION = 0x1
...
class PMPortSamplesCtl(rdma.binstruct.BinStruct):
    ...
    MEMBERS = [
        ...
        ("counterSelect8", 16, 1),
        ("counterSelect9", 16, 1),
        ("counterSelect10", 16, 1),
        ("counterSelect11", 16, 1),
        ("counterSelect12", 16, 1),
        ("counterSelect13", 16, 1),
        ("counterSelect14", 16, 1),
        ("reserved_544", 32, 1),
        ("samplesOnlyOptionMask", 64, 1),
        ("reserved_640", 896, 1),
    ]
...
class PMPortSamplesRes(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "tag", "reserved_16", "sampleStatus", "counter",
    )
    MAD_LENGTH = 64
    MAD_ATTRIBUTE_ID = 0x11
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortCounters(rdma.binstruct.BinStruct):
    ...
    MEMBERS = [
        ...
        ("portSelect", 8, 1),
        ("counterSelect", 16, 1),
        ("symbolErrorCounter", 16, 1),
        ("linkErrorRecoveryCounter", 8, 1),
        ("linkDownedCounter", 8, 1),
        ("portRcvErrors", 16, 1),
        ("portRcvRemotePhysicalErrors", 16, 1),
        ("portRcvSwitchRelayErrors", 16, 1),
        ("portXmitDiscards", 16, 1),
        ("portXmitConstraintErrors", 8, 1),
        ("portRcvConstraintErrors", 8, 1),
        ("counterSelect2", 8, 1),
        ("localLinkIntegrityErrors", 4, 1),
        ("excessiveBufferOverrunErrors", 4, 1),
        ("reserved_160", 16, 1),
        ("VL15Dropped", 16, 1),
        ("portXmitData", 32, 1),
        ("portRcvData", 32, 1),
...
class PMPortRcvErrorDetails(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portLocalPhysicalErrors", "portMalformedPacketErrors", "portBufferOverrunErrors", "portDLIDMappingErrors", "portVLMappingErrors", "portLoopingErrors",
    )
    MAD_LENGTH = 16
    MAD_ATTRIBUTE_ID = 0x15
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    ...
    MEMBERS = [
        ...
        ("portSelect", 8, 1),
        ("counterSelect", 16, 1),
        ("portLocalPhysicalErrors", 16, 1),
        ("portMalformedPacketErrors", 16, 1),
        ("portBufferOverrunErrors", 16, 1),
        ("portDLIDMappingErrors", 16, 1),
        ("portVLMappingErrors", 16, 1),
        ("portLoopingErrors", 16, 1),
    ]
...
class PMPortXmitDiscardDetails(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portInactiveDiscards", "portNeighborMTUDiscards", "portSwLifetimeLimitDiscards", "portSwHOQLimitDiscards",
    )
    MAD_LENGTH = 12
    MAD_ATTRIBUTE_ID = 0x16
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
    ...
    MEMBERS = [
        ...
        ("portSelect", 8, 1),
        ("counterSelect", 16, 1),
        ("portInactiveDiscards", 16, 1),
        ("portNeighborMTUDiscards", 16, 1),
        ("portSwLifetimeLimitDiscards", 16, 1),
...
class PMPortOpRcvCounters(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "opCode", "portSelect", "counterSelect", "portOpRcvPkts", "portOpRcvData",
    )
    MAD_LENGTH = 12
    MAD_ATTRIBUTE_ID = 0x17
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortFlowCtlCounters(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portXmitFlowPkts", "portRcvFlowPkts",
    )
    MAD_LENGTH = 12
    MAD_ATTRIBUTE_ID = 0x18
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortVLOpPackets(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "opCode", "portSelect", "counterSelect", "portVLOpPackets",
    )
    MAD_LENGTH = 36
    MAD_ATTRIBUTE_ID = 0x19
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortVLOpData(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "opCode", "portSelect", "counterSelect", "portVLOpData",
    )
    MAD_LENGTH = 68
    MAD_ATTRIBUTE_ID = 0x1a
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortVLXmitFlowCtlUpdateErrors(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portVLXmitFlowCtlUpdateErrors",
    )
    MAD_LENGTH = 8
    MAD_ATTRIBUTE_ID = 0x1b
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortVLXmitWaitCounters(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portVLXmitWait",
    )
    MAD_LENGTH = 36
...
class PMSwPortVLCongestion(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "swPortVLCongestion",
    )
    MAD_LENGTH = 36
    MAD_ATTRIBUTE_ID = 0x30
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortSamplesResExt(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "tag", "reserved_16", "sampleStatus", "extendedWidth", "reserved_34", "counter",
    )
    MAD_LENGTH = 128
...
class PMPortCountersExt(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "reserved_32", "portXmitData", "portRcvData", "portXmitPkts", "portRcvPkts", "portUnicastXmitPkts", "portUnicastRcvPkts", "portMulticastXmitPkts", "portMulticastRcvPkts",
    )
    MAD_LENGTH = 72
    ...
    MEMBERS = [
        ...
        ("portXmitPkts", 64, 1),
        ("portRcvPkts", 64, 1),
        ("portUnicastXmitPkts", 64, 1),
        ("portUnicastRcvPkts", 64, 1),
        ("portMulticastXmitPkts", 64, 1),
...
class PMPortXmitDataSL(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portXmitDataSL",
    )
    MAD_LENGTH = 68
    MAD_ATTRIBUTE_ID = 0x36
    MAD_PERFORMANCEGET = 0x1  # MAD_METHOD_GET
...
class PMPortRcvDataSL(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "reserved_0", "portSelect", "counterSelect", "portRcvDataSL",
    )
    MAD_LENGTH = 68
...
class DMIOUnitInfo(rdma.binstruct.BinStruct):
    ...
    __slots__ = (
        "changeID", "maxControllers", "reserved_24", "diagDeviceID", "optionROM", "controllerList",
    )
    MAD_LENGTH = 132
    MAD_ATTRIBUTE_ID = 0x10
    MAD_DEVMGTGET = 0x1  # MAD_METHOD_GET
...
class DMIOControllerProfile(rdma.binstruct.BinStruct):
    ...
    MEMBERS = [
        ...
        ("reserved_288", 16, 1),
        ("reserved_304", 16, 1),
        ("sendMessageDepth", 16, 1),
        ("reserved_336", 8, 1),
        ("RDMAReadDepth", 8, 1),
        ("sendMessageSize", 32, 1),
        ("RDMATransferSize", 32, 1),
        ("controllerOperationsMask", 8, 1),
        ("reserved_424", 8, 1),
        ("serviceEntries", 8, 1),
        ("reserved_440", 8, 1),
        ("reserved_448", 64, 1),
...
class DMServiceEntries(rdma.binstruct.BinStruct):
    ...
    def __init__(self, *args):
        self.serviceEntry = [DMServiceEntry() for _idx in range(4)]
        rdma.binstruct.BinStruct.__init__(self, *args)
...
class SNMPFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "reserved_192", "RAddress", "payloadLength", "segmentNumber", "sourceLID", "data",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x8
    MAD_CLASS_VERSION = 0x1
...
class VendOUIFormat(rdma.binstruct.BinFormat):
    ...
    __slots__ = (
        "baseVersion", "mgmtClass", "classVersion", "method", "status", "classSpecific", "transactionID", "attributeID", "reserved_144", "attributeModifier", "RMPPVersion", "RMPPType", "RRespTime", "RMPPFlags", "RMPPStatus", "data1", "data2", "reserved_288", "OUI", "data",
    )
    MAD_LENGTH = 256
    MAD_CLASS = 0x30
    MAD_CLASS_VERSION = 0x1
...
MEMBER_FORMATS = {'PKey': 'hex', 'QKey': 'hex', 'transactionID': 'hex', 'TClass': 'hex', 'serviceID': 'hex', 'localCMQKey': 'hex', 'localQKey': 'hex', 'altTClass': 'hex', 'capabilityMask': 'hex', 'capabilityMask2': 'hex', 'redirectTC': 'hex', 'redirectPKey': 'hex', 'redirectQP': 'hex', 'redirectQKey': 'hex', 'trapPKey': 'hex', 'trapQP': 'hex', 'trapQKey': 'hex', 'MKey': 'hex', 'nodeString': 'str', 'deviceID': 'hex', 'revision': 'hex', 'vendorID': 'hex', 'GIDPrefix': 'gid_prefix', 'diagCode': 'hex', 'initType': 'hex', 'initTypeReply': 'hex', 'PKeyBlock': 'hex', 'SMKey': 'hex', 'servicePKey': 'hex', 'serviceName': 'str', 'QOSClass': 'hex', 'MLID': 'hex', 'counterSelect0': 'hex', 'counterSelect1': 'hex', 'counterSelect2': 'hex', 'counterSelect3': 'hex', 'counterSelect4': 'hex', 'counterSelect5': 'hex', 'counterSelect6': 'hex', 'counterSelect7': 'hex', 'counterSelect8': 'hex', 'counterSelect9': 'hex', 'counterSelect10': 'hex', 'counterSelect11': 'hex', 'counterSelect12': 'hex', 'counterSelect13': 'hex', 'counterSelect14': 'hex', 'counterSelect': 'hex', 'IDString': 'str', 'communityName': 'str'}
